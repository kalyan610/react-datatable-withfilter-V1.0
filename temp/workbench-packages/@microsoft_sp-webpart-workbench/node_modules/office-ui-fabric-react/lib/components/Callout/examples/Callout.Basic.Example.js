...
var CalloutBasicExample = /** @class */ (function (_super) {
    ...
    CalloutBasicExample.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            ...
            this.state.isCalloutVisible && (React.createElement(Callout, { className: "ms-CalloutExample-callout", ariaLabelledBy: this._labelId, ariaDescribedBy: this._descriptionId, role: "alertdialog", gapSpace: 0, target: this._menuButtonElement.current, onDismiss: this._onCalloutDismiss, setInitialFocus: true },
                ...
                React.createElement("div", { className: "ms-CalloutExample-inner" },
                    ...
                    React.createElement("div", { className: "ms-CalloutExample-actions" },
                        React.createElement(Link, { className: "ms-CalloutExample-link", href: "http://microsoft.com", target: "_blank" }, "Go to microsoft")))))));
    };
