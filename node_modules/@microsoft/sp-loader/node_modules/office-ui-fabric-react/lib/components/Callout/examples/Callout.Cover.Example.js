...
var CalloutCoverExample = /** @class */ (function (_super) {
    ...
    CalloutCoverExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "ms-CalloutExample" },
            ...
            isCalloutVisible ? (React.createElement(Callout, { className: "ms-CalloutExample-callout", onDismiss: this._onDismiss, target: this._menuButtonElement, directionalHint: directionalHint, coverTarget: true, isBeakVisible: false, gapSpace: 0, setInitialFocus: true },
