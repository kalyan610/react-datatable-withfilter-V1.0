    ...
    FacepileOverflowExample.prototype.render = function () {
        ...
        return (React.createElement("div", { className: 'ms-FacepileExample' },
            ...
            React.createElement("div", { className: 'control' },
                React.createElement(Slider, { label: "Number of Personas:", min: 1, max: 5, step: 1, showValue: true, value: this.state.displayedPersonas, onChange: this._onChangePersonaNumber }),
                React.createElement(Dropdown, { label: "Overflow Button Type:", selectedKey: this.state.overflowButtonType, options: [
