...
var FilePicker = /** @class */ (function (_super) {
    ...
    function FilePicker(props) {
        ...
        _this.fileBrowserService = new FileBrowserService(props.context, _this.props.itemsCountQueryLimit);
        ...
        _this.fileSearchService = new FilesSearchService(props.context, _this.props.bingAPIKey);
        _this.state = {
            panelOpen: false,
            selectedTab: 'keyRecent',
    ...
    FilePicker.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "pnp__file-picker" },
            ...
            this.props.buttonIcon ?
                React.createElement(ActionButton, __assign({ iconProps: { iconName: this.props.buttonIcon } }, buttonProps)) :
                React.createElement(PrimaryButton, __assign({}, buttonProps)),
            React.createElement(Panel, { isOpen: this.state.panelOpen, isBlocking: true, hasCloseButton: true, className: "pnp__file-picker__panel " + styles.filePicker + " " + panelClassName, onDismiss: this._handleClosePanel, type: PanelType.extraLarge, isFooterAtBottom: true, onRenderNavigation: function () { return undefined; }, headerText: strings.FilePickerHeader, isLightDismiss: true, onRenderHeader: function () { return _this._renderHeader(); } },
                ...
                React.createElement("div", { className: styles.tabsContainer },
                    this.state.selectedTab === "keyLink" &&
                        React.createElement(LinkFilePickerTab, __assign({ fileSearchService: this.fileSearchService, allowExternalTenantLinks: true }, linkTabProps)),
                    this.state.selectedTab === "keyStockImages" &&
                        React.createElement(StockImages, __assign({ language: this.props.context.pageContext.cultureInfo.currentCultureName, fileSearchService: this.fileSearchService }, linkTabProps)),
                    this.state.selectedTab === "keyUpload" &&
                        React.createElement(UploadFilePickerTab, __assign({}, linkTabProps)),
                    this.state.selectedTab === "keySite" &&
                        React.createElement(SiteFilePickerTab, __assign({ fileBrowserService: this.fileBrowserService }, linkTabProps)),
                    this.state.selectedTab === "keyOrgAssets" &&
                        React.createElement(SiteFilePickerTab, __assign({ breadcrumbFirstNode: {
                                isCurrentItem: true,
                                text: strings.OrgAssetsTabLabel,
                                key: "keyOrgAssets"
                            }, fileBrowserService: this.orgAssetsService }, linkTabProps)),
                    this.state.selectedTab === "keyWeb" &&
                        React.createElement(WebSearchTab, __assign({ bingSearchService: this.fileSearchService }, linkTabProps)),
                    this.state.selectedTab === "keyOneDrive" &&
                        React.createElement(OneDriveFilesTab, __assign({ oneDriveService: this.oneDriveService }, linkTabProps)),
                    this.state.selectedTab === "keyRecent" &&
                        React.createElement(RecentFilesTab, __assign({ fileSearchService: this.fileSearchService }, linkTabProps))))));
    };
    return FilePicker;
}(React.Component));
export { FilePicker };
