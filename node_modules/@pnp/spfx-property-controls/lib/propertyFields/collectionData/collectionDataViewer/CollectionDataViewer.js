        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: "PropertyFieldCollectionData__panel__table " + styles.table + " " + (this.props.tableClassName || "") },
                React.createElement("div", { className: "PropertyFieldCollectionData__panel__table-head " + styles.tableRow + " " + styles.tableHead },
                    ...
                    this.props.fields.map(function (f) { return (React.createElement("span", { key: "dataviewer-" + f.id, className: "PropertyFieldCollectionData__panel__table-cell " + styles.tableCell },
                        f.title,
                        " ",
                    ...
                    React.createElement("span", { className: "PropertyFieldCollectionData__panel__table-cell " + styles.tableCell })),
                (this.state.crntItems && this.state.crntItems.length > 0) && (this.state.crntItems.map(function (item, idx, allItems) { return (React.createElement(CollectionDataItem, { key: item.uniqueId, fields: _this.props.fields, index: idx, item: item, totalItems: allItems.length, sortingEnabled: _this.props.enableSorting, disableItemDeletion: _this.props.disableItemDeletion, fUpdateItem: _this.updateItem, fDeleteItem: _this.deleteItem, fValidation: _this.validateItem, fOnSorting: _this.updateSortOrder })); })),
            ...
            React.createElement("div", { className: "PropertyFieldCollectionData__panel__actions " + styles.panelActions },
                this.state.inCreationItem && React.createElement(PrimaryButton, { text: this.props.saveAndAddBtnLabel || strings.CollectionSaveAndAddButtonLabel, onClick: this.addAndSave, disabled: !this.allItemsValid(), className: "PropertyFieldCollectionData__panel__action__add" }),
                !this.state.inCreationItem && React.createElement(PrimaryButton, { text: this.props.saveBtnLabel || strings.SaveButtonLabel, onClick: this.onSave, disabled: !this.allItemsValid(), className: "PropertyFieldCollectionData__panel__action__save" }),
