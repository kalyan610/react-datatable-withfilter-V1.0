 ...
 */
var PropertyFieldTeamPickerBuilder = /** @class */ (function () {
    /**
     * Constructor method
     */
    function PropertyFieldTeamPickerBuilder(_targetProperty, _properties) {
     ...
     */
    PropertyFieldTeamPickerBuilder.prototype.render = function (elem, ctx, changeCallback) {
        // Construct the JSX properties
        var element = React.createElement(PropertyFieldTeamPickerHost, {
            label: this.label,
    ...
    */
    PropertyFieldTeamPickerBuilder.prototype.dispose = function (elem) { };
    return PropertyFieldTeamPickerBuilder;
}());
/**
...
export function PropertyFieldTeamPicker(targetProperty, properties) {
    ...
    return new PropertyFieldTeamPickerBuilder(targetProperty, __assign({}, properties, { targetProperty: targetProperty, onDispose: null, onRender: null }));
}
