...
var TeamsSearchService = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [2 /*return*/, this.searchSitesFromMock(ctx, query)];
                    case 1: return [4 /*yield*/, ctx.msGraphClientFactory.getClient()];
                    case 2:
                    ...
                    case 3:
                        ...
                        res = [];
                        if (!(listOfTeams && listOfTeams.length > 0)) return [3 /*break*/, 5];
                        batchRequests_1 = [];
     ...
     */
    TeamsSearchService.prototype.searchSitesFromMock = function (ctx, query) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, [
