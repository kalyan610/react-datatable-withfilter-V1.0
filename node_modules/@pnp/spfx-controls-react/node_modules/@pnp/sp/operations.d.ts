...
export declare const spPost: <T = any>(o: ISharePointQueryable, options?: IFetchOptions) => Promise<T>;
export declare const spDelete: <T = any>(o: ISharePointQueryable, options?: IFetchOptions) => Promise<T>;
export declare const spPatch: <T = any>(o: ISharePointQueryable, options?: IFetchOptions) => Promise<T>;
