            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        apiUrl = "https://www.bingapis.com/api/v7/images/search?appid=" + this.bingAPIKey + "&traffictype=Internal_monitor&q=" + encodeURIComponent(query) + "&count=" + maxResults + "&aspect=" + aspect + "&maxFileSize=" + maxFileSize + "&size=" + size + "&mkt=en-US&license=" + license;
