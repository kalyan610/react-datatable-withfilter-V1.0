...
var FileBrowserService = /** @class */ (function () {
    function FileBrowserService(context, itemsToDownloadCount) {
         ...
         */
        this.getListItems = function (listUrl, folderPath, acceptedFilesExtensions, nextPageQueryStringParams) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        restApi = this.context.pageContext.web.absoluteUrl + "/_api/web/GetList('" + listUrl + "')/RenderListDataAsStream";
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            absoluteUrl_1 = this.context.pageContext.web.absoluteUrl;
                            restApi = absoluteUrl_1 + "/_api/SP.Web.GetDocumentAndMediaLibraries?webFullUrl='" + encodeURIComponent(absoluteUrl_1) + "'&includePageLibraries='" + includePageLibraries + "'";
        ...
        this.buildAbsoluteUrl = function (relativeUrl) {
            var siteUrl = GeneralHelper.getAbsoluteDomainUrl(_this.context.pageContext.web.absoluteUrl);
