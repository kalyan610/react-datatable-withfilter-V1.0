...
var AccessibleChartTable = /** @class */ (function (_super) {
    ...
    AccessibleChartTable.prototype._renderTableHeader = function () {
        ...
        var yHeaderRow = yAxisLabel
            && React.createElement("tr", { key: "yHeader-" + Guid.newGuid().toString() },
        ...
        var xHeaderCells = datasets.map(function (dataSet) {
            return React.createElement("th", { scope: 'col', key: "colHeading-" + Guid.newGuid().toString() }, escape(dataSet.label));
        });
        // Generate the X axis header row
        var xHeaderRow = React.createElement("tr", { key: "xHeader-" + Guid.newGuid().toString() },
    ...
    AccessibleChartTable.prototype._renderTableBody = function () {
        ...
        return data.labels && data.labels.map(function (labelValue, rowIndex) {
            var cells = data.datasets.map(function (dataSet, dsIndex) {
                return React.createElement("td", { key: "dataCell-" + Guid.newGuid().toString() }, dataSet.data[rowIndex]);
            });
            return React.createElement("tr", { key: "dataRow-" + Guid.newGuid().toString() },
                React.createElement("th", { key: "dataCellHEader-" + Guid.newGuid().toString() }, escape(labelValue)),
                cells);
        });
    };
    /**
