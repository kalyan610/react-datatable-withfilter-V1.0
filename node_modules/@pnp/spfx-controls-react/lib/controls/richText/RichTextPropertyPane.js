...
var RichTextPropertyPane = /** @class */ (function (_super) {
    ...
    function RichTextPropertyPane(props) {
        ...
        _this.renderFontStylesGroup = function () {
            ...
            return (React.createElement("div", { className: styles.propertyPaneGroupField },
                React.createElement(Dropdown, { label: strings.FontStyleTitle, ariaLabel: strings.FontStyleTitle, defaultSelectedKey: 0, selectedKey: selectedHeader, options: [
        ...
        _this.renderFontSizesGroup = function () {
            ...
            return (React.createElement("div", { className: styles.propertyPaneGroupField },
                React.createElement(Dropdown, { label: strings.FontSizeTitle, ariaLabel: strings.FontSizeTitle, defaultSelectedKey: 'large', selectedKey: selectedSize, options: [
                        { key: 'small', text: '12' },
                        { key: 'medium', text: '14' },
