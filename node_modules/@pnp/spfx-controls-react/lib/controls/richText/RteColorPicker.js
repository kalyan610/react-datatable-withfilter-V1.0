    ...
    RteColorPicker.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { ref: function (ref) { return _this.wrapperRef = ref; } },
                React.createElement(TooltipHost, { content: buttonLabel, id: id, calloutProps: { gapSpace: 0 } },
                    React.createElement(DefaultButton, { className: styles.colorPickerButton, "aria-describedby": id, onClick: function () { return _this.handleColorChanged(previewColor); } },
                        React.createElement("svg", { className: styles.previewSvg + " " + ((previewColor === "rgba(0, 0, 0, 0)" || previewColor === "#ffffff") ? styles.border : ""), fill: previewColor, viewBox: "0 0 20 20" },
            ...
            React.createElement(Callout, { isBeakVisible: false, directionalHint: 4, className: styles.pickerCallout, setInitialFocus: true, gapSpace: 0, role: "alertdialog", hidden: !this.state.isCalloutVisible, target: this.wrapperRef, onDismiss: function () { return _this.setState({ isCalloutVisible: false }); } },
                React.createElement(TooltipHost, { content: defaultButtonLabel, id: id + "DefaultButton", calloutProps: { gapSpace: 0 } },
                    React.createElement(DefaultButton, { className: styles.colorPickerButton, "aria-describedby": id + "DefaultButton", onClick: this.handleSwitchToDefault },
                        React.createElement("svg", { className: styles.previewSvg + " " + styles.defaultSvg + " " + (fillThemeColor ? styles.fillThemeColor : styles.fillDefaultColor) + " " + (fillThemeColor ? "" : styles.border), viewBox: "0 0 20 20" },
                            React.createElement("rect", { className: styles.previewRectangle, width: "100%", height: "100%" })),
