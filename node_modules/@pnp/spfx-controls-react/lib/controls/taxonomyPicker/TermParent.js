    ...
    TermParent.prototype.componentWillMount = function () {
        ...
        if (this.props.anchorId) {
            ...
            if (anchorTerm_1) {
                ...
                var anchorTermPath_1 = anchorTerm_1.PathOfTerm + ";";
    ...
    TermParent.prototype.render = function () {
        ...
        if (this.state.loaded) {
            if (this._terms.length > 0) {
                ...
                termElm = React.createElement("div", { className: styles.listItem + " " + styles.term }, strings.TaxonomyPickerNoTerms);
            }
        }
        else {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: styles.listItem + " " + styles.termset + " " + ((!this.props.anchorId && this.props.isTermSetSelectable) ? styles.termSetSelectable : ""), onClick: this._handleClick },
