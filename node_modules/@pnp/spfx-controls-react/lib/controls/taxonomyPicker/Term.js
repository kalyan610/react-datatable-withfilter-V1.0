...
var Term = /** @class */ (function (_super) {
    ...
    Term.prototype.render = function () {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: styles.listItem + " " + styles.term, style: styleProps },
                React.createElement("div", null,
                    React.createElement(Checkbox, { checked: this.state.selected, style: checkBoxStyle, disabled: this.props.term.IsDeprecated || !this.props.term.IsAvailableForTagging || this.props.disabled || this.state.disabled, className: this.getClassName(), label: this.state.termLabel, onChange: this._handleChange })),
