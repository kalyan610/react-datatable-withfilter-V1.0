...
var FieldUserRenderer = /** @class */ (function (_super) {
    ...
    function FieldUserRenderer(props, state) {
        ...
        _this._userImageUrl = GeneralHelper.trimSlash(props.context.pageContext.web.absoluteUrl) + "/_layouts/15/userphoto.aspx?size=L&accountname={0}";
    ...
    FieldUserRenderer.prototype.componentWillReceiveProps = function (nextProps) {
        var _this = this;
    ...
    FieldUserRenderer.prototype.render = function () {
        ...
        var userEls = this.state.users.map(function (user, index) {
            ...
            return React.createElement(FieldUserHoverCard, __assign({}, hoverCardProps));
        });
    ...
    FieldUserRenderer.prototype._onRenderCompactCard = function (index, user) {
        ...
        if (user.currentUser) {
            ...
            actionsEl = React.createElement("div", { className: styles.actions },
                React.createElement(IconButton, { iconProps: { iconName: 'Mail' }, title: strings.SendEmailTo.replace('{0}', user.email), href: "mailto:" + user.email }),
                React.createElement(IconButton, { iconProps: { iconName: 'Chat' }, title: strings.StartChatWith.replace('{0}', sip), href: "sip:" + sip, className: styles.chat }));
        }
            ...
            return React.createElement("ul", { className: styles.sections },
                React.createElement("li", { className: styles.section },
                    ...
                    React.createElement("div", { className: styles.contactItem },
                        ...
                        React.createElement(Link, { className: styles.content, title: user.email, href: "mailto:" + user.email, target: '_self' }, user.email)),
                    user.workPhone &&
                        React.createElement("div", { className: styles.contactItem },
                            React.createElement(Icon, { iconName: 'Phone' }),
                            React.createElement(Link, { className: styles.content, title: user.workPhone, href: "tel:" + user.workPhone, target: '_self' }, user.workPhone)),
                    user.cellPhone &&
                        React.createElement("div", { className: styles.contactItem },
                            React.createElement(Icon, { iconName: 'Phone' }),
                            React.createElement(Link, { className: styles.content, title: user.cellPhone, href: "tel:" + user.cellPhone, target: '_self' }, user.cellPhone))));
        }
        else {
