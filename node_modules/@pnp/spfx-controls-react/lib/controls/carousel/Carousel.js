...
import { CarouselButtonsDisplay, CarouselButtonsLocation, CarouselIndicatorShape } from ".";
...
var Carousel = /** @class */ (function (_super) {
    ...
    function Carousel(props) {
        ...
        _this.renderSlide = function (element) {
            ...
            if (!isAnimated || previousIndex === undefined) {
                return [React.createElement("div", { className: styles.slideWrapper }, element)];
            }
        ...
        _this.getIndicatorsElement = function () {
            ...
            var _loop_1 = function (i) {
                ...
                if (onRenderIndicator) {
                    ...
                    indicatorElements.push(React.createElement("li", { className: css(indicatorClassName, (_a = {},
                            _a[styles.active] = i === currentIndex,
        ...
        return (React.createElement("div", { className: this.getMergedStyles(styles.root, rootStyles) },
            React.createElement("div", { className: this.getMergedStyles(styles.container, containerStyles) },
                React.createElement("div", { className: this.getMergedStyles(this.getButtonContainerStyles(), containerButtonsStyles), onClick: function () { if (!prevButtonDisabled) {
                    ...
                    React.createElement(IconButton, { className: this.getMergedStyles(this.getButtonStyles(false), prevButtonStyles), iconProps: { iconName: prevButtonIconName }, disabled: prevButtonDisabled, onClick: function () { _this.onCarouselButtonClicked(false); } })),
                React.createElement("div", { className: this.getMergedStyles(styles.contentContainer, contentContainerStyles), onMouseOver: pauseOnHover && interval !== null ? this.pauseCycle : undefined, onTouchStart: pauseOnHover && interval !== null ? this.pauseCycle : undefined, onMouseLeave: pauseOnHover && interval !== null ? this.startCycle : undefined, onTouchEnd: pauseOnHover && interval !== null ? this.startCycle : undefined },
                    processing &&
                ...
                React.createElement("div", { className: this.getMergedStyles(this.getButtonContainerStyles(), containerButtonsStyles), onClick: function () { if (!nextButtonDisabled) {
                    ...
                    React.createElement(IconButton, { className: this.getMergedStyles(this.getButtonStyles(true), nextButtonStyles), iconProps: { iconName: nextButtonIconName }, disabled: nextButtonDisabled, onClick: function () { _this.onCarouselButtonClicked(true); } }))),
    ...
    Carousel.prototype.getButtonContainerStyles = function () {
        ...
        var buttonsLocation = this.props.buttonsLocation ? this.props.buttonsLocation : CarouselButtonsLocation.top;
