...
var HoursComponent = /** @class */ (function (_super) {
    ...
    HoursComponent.prototype.render = function () {
        ...
        if (renderDropdown) {
            ...
            return (React.createElement(MaskedTextField, { disabled: disabled, label: "", value: value ? TimeHelper.hoursValue(value, timeConvention) : "" + (timeConvention === TimeConvention.Hours24 ? "00" : "12 AM"), mask: timeConvention === TimeConvention.Hours24 ? "29" : "19 AM", maskFormat: {
                    '1': /[0-1]/,
                    '2': /[0-2]/,
                    '9': /[0-9]/,
                    'A': /[AaPp]/,
    ...
    HoursComponent.prototype._initHoursOptions = function () {
        var amDesignator = 'AM';
        var pmDesignator = 'PM';
        var _a = this.props, value = _a.value, timeConvention = _a.timeConvention;
