...
var Progress = /** @class */ (function (_super) {
    ...
    Progress.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.progress + " " + (className || ""), style: { height: height || 'auto' } },
            (title || showOverallProgress || this.state.showLongRunningText) && (React.createElement("div", { className: styles.header + " " + (headerClassName || "") },
            ...
            React.createElement("div", { className: styles.actionsContainer + " " + (actionsContainerClassName || "") }, actionEls)));
    };
