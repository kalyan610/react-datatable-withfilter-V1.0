...
export var ToolbarTheme = function (_a) {
    ...
    var mainTheme = (globalTheme.siteVariables && globalTheme.siteVariables.theme)
        ? globalTheme
        : themes.teamsTheme;
    return (React.createElement(FluentUIThemeProvider, { theme: mergeThemes(mainTheme, teamsNextVariableAssignments, getLocalTheme(globalTheme.siteVariables.theme)), styles: { background: "transparent" } }, children));
};
