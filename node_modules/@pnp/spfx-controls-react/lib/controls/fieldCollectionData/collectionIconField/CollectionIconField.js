...
var CollectionIconField = /** @class */ (function (_super) {
    ...
    CollectionIconField.prototype.render = function () {
        ...
        return (React.createElement("div", { className: "FieldCollectionData__panel__icon-field " + styles.iconField },
            React.createElement(TextField, { placeholder: field.placeholder || field.title, className: styles.collectionDataField, value: item[field.id] ? item[field.id] : "", required: field.required, onChanged: function (value) { return _this.props.fOnValueChange(field.id, value); }, deferredValidationTime: field.deferredValidationTime || field.deferredValidationTime >= 0 ? field.deferredValidationTime : 200, onGetErrorMessage: function (value) { return _this.props.fValidation(_this.props.field, value); }, disabled: this.props.disableEdit }),
