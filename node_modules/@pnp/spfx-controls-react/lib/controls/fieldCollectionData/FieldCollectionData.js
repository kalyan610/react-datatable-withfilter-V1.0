...
var FieldCollectionData = /** @class */ (function (_super) {
    ...
    FieldCollectionData.prototype.render = function () {
        return (React.createElement("div", null,
            ...
            React.createElement(Panel, { isOpen: this.state.panelOpen, onDismiss: this.closePanel, type: PanelType.large, headerText: this.props.panelHeader, onOuterClick: function () { }, className: "FieldCollectionData__panel " + (this.props.panelClassName || "") },
