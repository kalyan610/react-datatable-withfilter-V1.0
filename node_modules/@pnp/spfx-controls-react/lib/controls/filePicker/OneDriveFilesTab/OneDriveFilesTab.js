    ...
    OneDriveFilesTab.prototype.render = function () {
        ...
        return (React.createElement("div", { className: styles.tabContainer },
            ...
            React.createElement("div", { className: styles.tabFiles }, this.state.libraryAbsolutePath !== undefined &&
                React.createElement(FileBrowser, { onChange: function (filePickerResult) { return _this._handleSelectionChange(filePickerResult); }, onOpenFolder: function (folder) { return _this._handleOpenFolder(folder, true); }, fileBrowserService: this.props.oneDriveService, libraryUrl: this.state.libraryUrl, folderPath: this.state.folderPath, accepts: this.props.accepts })),
