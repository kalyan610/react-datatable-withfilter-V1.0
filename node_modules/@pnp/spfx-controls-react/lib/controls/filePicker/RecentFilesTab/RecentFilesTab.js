        ...
        _this._onSelectionChanged = function () {
            ...
            if (selectedItems && selectedItems.length > 0) {
                ...
                var filePickerResult = {
                    ...
                    fileName: GeneralHelper.getFileNameFromUrl(selectedKey_1.fileUrl),
                    fileNameWithoutExtension: GeneralHelper.getFileNameWithoutExtension(selectedKey_1.fileUrl),
                    downloadFileContent: function () { return _this.props.fileSearchService.downloadSPFileContent(selectedKey_1.fileUrl, GeneralHelper.getFileNameFromUrl(selectedKey_1.fileUrl)); }
                };
        ...
        _this._renderGridList = function () {
            return React.createElement("span", { className: styles.recentGridList, role: "grid" },
                React.createElement(FocusZone, null,
                    React.createElement(SelectionZone, { selection: _this._selection, onItemInvoked: function (item) { return _this._handleItemInvoked(item); } },
