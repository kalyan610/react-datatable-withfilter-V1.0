...
var FolderTile = /** @class */ (function (_super) {
    ...
    FolderTile.prototype.render = function () {
        ...
        return (React.createElement("div", { "aria-selected": isSelected, "data-is-draggable": false, role: "listitem", "aria-labelledby": "Tile-label" + index, "aria-describedby": "Tile-activity" + index, className: css(styles.tile, isLarge ? styles.isLarge : styles.isSmall, styles.invokable, isSelected ? styles.selected : undefined), "data-is-focusable": true, "data-is-sub-focuszone": true, "data-disable-click-on-enter": true, "data-selection-index": index, onClick: function (_event) { return _this.props.onItemInvoked(item); } },
