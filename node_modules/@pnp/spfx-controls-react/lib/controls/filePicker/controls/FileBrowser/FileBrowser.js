...
import { DetailsList, DetailsListLayoutMode, Selection, SelectionMode, DetailsRow } from 'office-ui-fabric-react/lib/DetailsList';
...
var FileBrowser = /** @class */ (function (_super) {
        ...
        var columns = [
            {
                ...
                onRender: function (item) {
                    ...
                    var isPhoto = GeneralHelper.isImage(item.name);
                ...
                React.createElement("div", null,
                    ...
                    React.createElement("div", { className: styles.scrollablePaneWrapper },
                        React.createElement(ScrollablePane, null, this.state.selectedView !== 'tiles' ?
                            ...
                            (React.createElement(TilesList, { fileBrowserService: this.props.fileBrowserService, filePickerResult: this.state.filePickerResult, selection: this._selection, items: this.state.items, onFolderOpen: this._handleOpenFolder, onFileSelected: this._itemSelectionChanged, onNextPageDataRequest: this._loadNextDataRequest }))))),
    ...
    FileBrowser.prototype._getListItems = function (concatenateResults) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _a, libraryUrl, folderPath, accepts, _b, items, nextPageQueryString, filesQueryResult, loadingState, error_1, newItems;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.props, libraryUrl = _a.libraryUrl, folderPath = _a.folderPath, accepts = _a.accepts;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.props.fileBrowserService.getListItems(libraryUrl, folderPath, accepts, nextPageQueryString)];
                    case 2:
