            ...
            return (React.createElement("div", { className: styles.listCell, "data-item-index": index, style: {
                ...
                React.createElement("div", { role: "presentation", className: styles.cell, 
                    ...
                    React.createElement("div", { role: "presentation", className: styles.cellContent }, item.isFolder ?
                        React.createElement(FolderTile, { item: item, index: index, isSelected: isSelected, pageWidth: _this._pageWidth, tileDimensions: {
                        ...
                        :
                            React.createElement(DocumentTile, { fileBroserService: _this.props.fileBrowserService, item: item, index: index, isSelected: isSelected, pageWidth: _this._pageWidth, tileDimensions: {
                                    width: _this._columnWidth - TILE_HORZ_PADDING,
                                    height: _this._rowHeight - TILE_HORZ_PADDING
                                }, onItemInvoked: function (itemInvoked) { return _this._handleItemInvoked(itemInvoked); } })))));
        };
