        ...
        return (React.createElement("div", { className: styles.tabContainer },
            ...
            React.createElement("div", { className: styles.tabFiles },
                this.state.libraryAbsolutePath === undefined &&
                    React.createElement(DocumentLibraryBrowser, { fileBrowserService: this.props.fileBrowserService, onOpenLibrary: function (selectedLibrary) { return _this._handleOpenLibrary(selectedLibrary, true); } }),
                this.state.libraryAbsolutePath !== undefined &&
