        ...
        return (React.createElement("div", null,
                ...
                React.createElement("div", { className: styles.selection },
                    ...
                    this.state.selectedFolder &&
                        React.createElement("div", { className: styles.selectFolder },
                            React.createElement(Link, { className: styles.selectFolder, target: '_blank', "data-interception": "off", id: this._folderLinkId, href: this.state.selectedFolder.ServerRelativeUrl },
            ...
            React.createElement(Panel, { isOpen: this.state.showPanel, type: PanelType.medium, onDismiss: this._hidePanel, headerText: "Select folder", closeButtonAriaLabel: "Close", onRenderFooterContent: this._onRenderFooterContent },
                React.createElement("div", null,
                    React.createElement(FolderExplorer, { context: this.props.context, rootFolder: this.props.rootFolder, defaultFolder: this.state.selectedFolder, onSelect: this._onFolderSelect, canCreateFolders: this.props.canCreateFolders })))));
    };
    return FolderPicker;
}(React.Component));
export { FolderPicker };
