...
describe('mergeThemes', function () {
    ...
    describe('componentStyles', function () {
        ...
        test('component parts without styles are not merged', function () {
            var target = { componentStyles: { Button: { root: {} } } };
            var source = { componentStyles: { Button: { icon: {} } } };
            var merged = styles_1.mergeThemes(target, source);
        ...
        test('functions can accept and apply params', function () {
            ...
            expect(merged.componentStyles.Button.root(styleParam)).toMatchObject(tslib_1.__assign({ source: true, target: true }, styleParam));
        });
    });
