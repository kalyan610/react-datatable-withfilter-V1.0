...
describe('mergeComponentStyles', function () {
    ...
    function testMergeComponentStyles(mergeComponentStyles) {
        ...
        test('component parts without styles are not merged', function () {
            var target = { root: {} };
            var source = { icon: {} };
    ...
    describe('dev version, debug enabled', function () {
        ...
        describe('debug frames', function () {
            ...
            test('are flat for recursive merge', function () {
                ...
                var merged1 = mergeThemes_1.mergeComponentStyles__DEV(target, source1, source2);
                ...
                var merged2 = mergeThemes_1.mergeComponentStyles__DEV(mergeThemes_1.mergeComponentStyles__DEV(target, source1), source2);
                var resolvedRoot2 = merged2.root(styleParam);
                expect(resolvedRoot2).toMatchObject({
                    _debug: [{ debugId: 'target' }, { debugId: 'source1' }, { debugId: 'source2' }],
                });
                var merged3 = mergeThemes_1.mergeComponentStyles__DEV(target, mergeThemes_1.mergeComponentStyles__DEV(source1, source2));
