...
var toolbarColorAreas = (0, _utils.stringLiteralsArray)('foreground1', 'background', 'border', 'foregroundActive', 'foregroundHover', 'backgroundHover', 'foregroundDisabled1', // custom
...
var toolbarVariables = function toolbarVariables(siteVars) {
  return {
    ...
    menuItemPadding: (0, _utils.pxToRem)(9) + " " + (0, _utils.pxToRem)(16),
