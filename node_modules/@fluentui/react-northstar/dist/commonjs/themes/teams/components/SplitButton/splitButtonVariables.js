...
exports.splitButtonVariables = void 0;

var _utils = require("../../../../utils");

var splitButtonVariables = function splitButtonVariables(siteVars) {
  return {
    ...
    smallDimension: (0, _utils.pxToRem)(24),
    smallPadding: "0 " + (0, _utils.pxToRem)(8),
    smallMinWidth: '0',
    smallBoxShadow: 'none',
    padding: "0 " + (0, _utils.pxToRem)(12),
    minWidth: '0',
    toggleButtonHeight: (0, _utils.pxToRem)(32),
    ...
    toggleButtonIndicatorSize: (0, _utils.pxToRem)(16),
...
exports.splitButtonVariables = splitButtonVariables;
