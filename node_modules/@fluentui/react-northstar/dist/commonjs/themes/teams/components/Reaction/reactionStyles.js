...
exports.reactionStyles = void 0;

var _Reaction = require("../../../../components/Reaction/Reaction");

var _utils = require("../../../../utils");

var contentClassNameSelector = "& ." + _Reaction.reactionSlotClassNames.content;
var reactionStyles = {
  root: function root(_ref) {
    ...
    return {
      ...
      border: (0, _utils.pxToRem)(0),
      padding: (0, _utils.pxToRem)(0),
      display: 'inline-flex',
  ...
  icon: function icon(_ref2) {
    ...
    return {
      ...
      alignItems: 'center',
      justifyContent: 'center',
      marginRight: p.hasContent ? (0, _utils.pxToRem)(4) : (0, _utils.pxToRem)(0)
    };
  },
...
exports.reactionStyles = reactionStyles;
