...
exports.attachmentVariables = void 0;

var _utils = require("../../../../utils");

var attachmentVariables = function attachmentVariables(siteVariables) {
  return {
    padding: (0, _utils.pxToRem)(7) + " " + (0, _utils.pxToRem)(3) + " " + (0, _utils.pxToRem)(7) + " " + (0, _utils.pxToRem)(11),
    // padding set to 1px less to account for 1px border
    iconSpace: (0, _utils.pxToRem)(12),
    iconSize: (0, _utils.pxToRem)(32),
    borderColor: siteVariables.colorScheme.default.border3,
    borderRadius: (0, _utils.pxToRem)(3),
    ...
    progressHeight: (0, _utils.pxToRem)(4),
    ...
    // action variables
    actionHeight: (0, _utils.pxToRem)(32),
    actionMaxWidth: (0, _utils.pxToRem)(280),
    ...
    actionIconSize: (0, _utils.pxToRem)(16),
    actionLoaderBorderSize: (0, _utils.pxToRem)(2),
    actionLoaderSize: (0, _utils.pxToRem)(20),
    actionLoaderSvgHeight: (0, _utils.pxToRem)(1220),
    actionLoaderSvgAnimationHeight: (0, _utils.pxToRem)(-1200),
    actionFocusBorderRadius: (0, _utils.pxToRem)(3)
  };
};

exports.attachmentVariables = attachmentVariables;
