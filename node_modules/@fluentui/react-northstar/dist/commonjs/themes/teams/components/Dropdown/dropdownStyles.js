...
var _clearIndicatorUrl = require("./clearIndicatorUrl");

var _toggleIndicatorUrl = require("./toggleIndicatorUrl");
...
var dropdownStyles = {
  ...
  clearIndicator: function clearIndicator(_ref2) {
    ...
    }, p.isEmptyClearIndicator && {
      backgroundImage: (0, _clearIndicatorUrl.clearIndicatorUrl)(v.color)
    }, {
  ...
  toggleIndicator: function toggleIndicator(_ref10) {
    ...
    return Object.assign({
      ...
      display: 'flex',
      justifyContent: 'center',
      backgroundImage: (0, _toggleIndicatorUrl.toggleIndicatorUrl)(p.disabled ? v.disabledColor : v.color),
      backgroundPosition: 'center',
      backgroundRepeat: 'no-repeat',
      cursor: 'pointer'
    }, p.disabled && {
