...
var Animation = function Animation(props) {
  ...
  var element = /*#__PURE__*/React.createElement(_reactTransitionGroup.Transition, (0, _extends2.default)({
    ...
    className: !isChildrenFunction ? (0, _classnames.default)(animationClasses, className, (_ref = child) == null ? void 0 : (_ref$props = _ref.props) == null ? void 0 : _ref$props.className) : ''
  }), isChildrenFunction ? function () {
    return children({
      classes: (0, _classnames.default)(animationClasses, className)
    });
  } : child);
  setEnd();
  return element;
