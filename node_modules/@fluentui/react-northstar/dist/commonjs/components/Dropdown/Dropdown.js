...
var Dropdown = function Dropdown(props) {
      ...
      var handleInputKeyDown = function handleInputKeyDown(e, searchInputProps) {
        if (!disabled) {
          switch ((0, _keyboardKey.getCode)(e)) {
            ...
            case _keyboardKey.keyboardKey.ArrowRight:
              e.stopPropagation();
            ...
            case _keyboardKey.keyboardKey.Backspace:
              e.stopPropagation();
              tryRemoveItemFromValue();
              break;

            case _keyboardKey.keyboardKey.Escape:
  ...
  var handleSelectedItemKeyDown = function handleSelectedItemKeyDown(e, item, predefinedProps, dropdownSelectedItemProps) {
    var previousKey = context.rtl ? _keyboardKey.keyboardKey.ArrowRight : _keyboardKey.keyboardKey.ArrowLeft;
    var nextKey = context.rtl ? _keyboardKey.keyboardKey.ArrowLeft : _keyboardKey.keyboardKey.ArrowRight;

    switch ((0, _keyboardKey.getCode)(e)) {
      case _keyboardKey.keyboardKey.Delete:
      case _keyboardKey.keyboardKey.Backspace:
        handleSelectedItemRemove(e, item, predefinedProps, dropdownSelectedItemProps);
        break;
  ...
  var element = /*#__PURE__*/React.createElement(ElementType, (0, _extends2.default)({
    ...
    }, multiple && renderSelectedItems(), search ? renderSearchInput(accessibilityRootPropsRest, highlightedIndex, getInputProps, selectItemAtIndex, toggleMenu, variables) : renderTriggerButton(getToggleButtonProps)), showClearIndicator ? _Box.Box.create(clearIndicator, {
      defaultProps: function defaultProps() {
        return Object.assign({
