...
var Tree = function Tree(props) {
  ...
  var setSelectedItemIds = React.useCallback(function (e, updateSelectedItemIds) {
    (0, _invoke2.default)(stableProps.current, 'onSelectedItemIdsChange', e, Object.assign({}, stableProps.current, {
  ...
  var setActiveItemIds = React.useCallback(function (e, updateActiveItemIds) {
    (0, _invoke2.default)(stableProps.current, 'onActiveItemIdsChange', e, Object.assign({}, stableProps.current, {
  ...
  var expandItems = React.useCallback(function (e, treeItemProps) {
    ...
    setActiveItemIds(e, function (currActiveItemIds) {
      var siblings = (0, _utils2.getSiblings)(stableProps.current.items, id);
      var activeItemIdIndex = currActiveItemIds.indexOf(id);
      var nextActiveItemsIds = currActiveItemIds;

      if (activeItemIdIndex > -1) {
        nextActiveItemsIds = (0, _utils2.removeItemAtIndex)(currActiveItemIds, activeItemIdIndex);
      } else {
        if (exclusive) {
          siblings.some(function (sibling) {
            ...
            if (activeSiblingIdIndex > -1) {
              nextActiveItemsIds = (0, _utils2.removeItemAtIndex)(currActiveItemIds, activeSiblingIdIndex);
              return true;
            }
  ...
  var onTitleClick = React.useCallback(function (e, treeItemProps, executeSelection) {
    ...
    if (treeItemProps.selectable) {
      ...
      setSelectedItemIds(e, function (currSelectedItemIds) {
        return (0, _utils2.processItemsForSelection)(treeItemProps, currSelectedItemIds);
      });
    }
  ...
  var onFocusFirstChild = React.useCallback(function (itemId) {
    ...
    var elementToBeFocused = (0, _reactBindings.getNextElement)(treeRef.current, currentElement.current);
  ...
  var onSiblingsExpand = React.useCallback(function (e, treeItemProps) {
    ...
    setActiveItemIds(e, function (currActiveItemIds) {
      ...
      siblings.forEach(function (sibling) {
        if ((0, _utils2.hasSubtree)(sibling) && !isActiveItem(sibling['id'])) {
          nextActiveItemsIds.push(sibling['id']);
        }
      });

      if ((0, _utils2.hasSubtree)(treeItemProps) && !isActiveItem(id)) {
  ...
  var isIndeterminate = function isIndeterminate(item) {
    ...
    var selectableItemIds = (0, _utils2.getAllSelectableChildrenId)(item.items);
    return !(0, _utils2.isAllGroupChecked)(item.items, selectedItemIds) && selectableItemIds.some(function (id) {
  ...
  var isSelectedItem = function isSelectedItem(item) {
    if (item.selectableParent && item.items) {
      return (0, _utils2.isAllGroupChecked)(item.items, selectedItemIds);
    }
  ...
  var renderContent = function renderContent() {
    ...
    var renderItems = function renderItems(items, level, parent) {
      ...
      return items.reduce(function (renderedItems, item, index) {
        ...
        var renderedItem = _TreeItem.TreeItem.create(item, {
  ...
  var element = /*#__PURE__*/React.createElement(_utils2.TreeContext.Provider, {
    value: contextValue
