...
var Dialog = function Dialog(props) {
  ...
  contentId.current = (0, _utils2.getOrGenerateIdFromShorthand)('dialog-content-', content, contentId.current);
  var headerId = React.useRef();
  headerId.current = (0, _utils2.getOrGenerateIdFromShorthand)('dialog-header-', header, headerId.current);
  ...
  React.useEffect(function () {
    if (open) {
      (0, _utils.lockBodyScroll)(context.target);
    }

    return function () {
      if (open) {
        (0, _utils.unlockBodyScroll)(context.target);
      }
    };
  }, [context.target, open]);
  ...
  var handleOverlayClick = function handleOverlayClick(e) {
    ...
    // refs
    var isInsideContentClick = (0, _utils2.doesNodeContainClick)(contentRef.current, e, context.target);
    var isInsideOverlayClick = (0, _utils2.doesNodeContainClick)(overlayRef.current, e, context.target);
  ...
  var handleDocumentKeydown = function handleDocumentKeydown(getRefs) {
    return function (e) {
      ...
      if (targetIsBody && (0, _keyboardKey.getCode)(e) === _keyboardKey.keyboardKey.Escape && isLastOpenedDialog) {
        handleDialogCancel(e);
        (0, _invoke2.default)(triggerRef, 'current.focus');
      }
    };
  ...
  var cancelElement = (0, _utils2.createShorthand)(_Button.Button, cancelButton, {
    overrideProps: handleCancelButtonOverrides
  });
  var confirmElement = (0, _utils2.createShorthand)(_Button.Button, confirmButton, {
  ...
  }), (0, _utils2.createShorthand)(_Button.Button, headerAction, {
    defaultProps: function defaultProps() {
...
Dialog.propTypes = Object.assign({}, _utils2.commonPropTypes.createCommon({
  children: false,
  content: 'shorthand'
}), {
...
Dialog.create = (0, _utils2.createShorthandFactory)({
  Component: Dialog
});
