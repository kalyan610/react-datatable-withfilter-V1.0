...
var getAccordionTitleAtIndex = function (accordion, index) {
    return utils_1.findIntrinsicElement(accordion, "." + AccordionTitle_1.accordionTitleSlotClassNames.contentWrapper)
        .at(index)
        .getDOMNode();
};
describe('Accordion', function () {
    commonTests_1.isConformant(Accordion_1.Accordion, { constructorName: 'Accordion', autoControlledProps: ['activeIndex'] });
    ...
    describe('focusedIndex', function () {
        ...
        it('focuses the button element when is changed via focus handler', function () {
            ...
            title.simulate('keydown', { keyCode: keyboard_key_1.keyboardKey.ArrowUp, key: 'ArrowUp' });
