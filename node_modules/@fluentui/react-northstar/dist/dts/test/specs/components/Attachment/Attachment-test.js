...
describe('Attachment', function () {
    commonTests_1.isConformant(Attachment_1.Attachment, { constructorName: 'Attachment' });
    ...
    describe('accessibility', function () {
        ...
        test('handleClick is executed when Enter is pressed on attachment element', function () {
            ...
            attachment.find("." + Attachment_1.attachmentClassName).simulate('keydown', { keyCode: keyboard_key_1.keyboardKey.Enter });
