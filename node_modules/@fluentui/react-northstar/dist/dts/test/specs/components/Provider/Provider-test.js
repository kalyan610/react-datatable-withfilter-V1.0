...
describe('Provider', function () {
    ...
    describe('calls provided renderer', function () {
        ...
        test('calls renderFont', function () {
            ...
            var createRenderer = function () { return (tslib_1.__assign(tslib_1.__assign({}, react_northstar_styles_renderer_1.noopRenderer), { renderFont: renderFont })); };
    ...
    test('calls renderStatic', function () {
        ...
        var createRenderer = function () { return (tslib_1.__assign(tslib_1.__assign({}, react_northstar_styles_renderer_1.noopRenderer), { renderGlobal: renderGlobal })); };
        enzyme_1.mount(React.createElement(react_bindings_1.RendererContext.Provider, { value: createRenderer },
            React.createElement(Provider_1.Provider, { theme: theme, target: createDocumentMock() },
                React.createElement("div", null))));
