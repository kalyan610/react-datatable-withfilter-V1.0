...
describe('Dropdown', function () {
    ...
    describe('value', function () {
        ...
        it('has onChange called when item is added', function () {
            var itemToClickIndex = 2;
            var onChange = jest.fn();
            var clickOnItemAtIndex = test_utils_2.renderDropdown({ open: true, onChange: onChange }).clickOnItemAtIndex;
        ...
        it('has onChange called with null value by hitting Escape in search input', function () {
            var onChange = jest.fn();
        ...
        it('has the item removed if it receives click on remove icon', function () {
            ...
            utils_1.findIntrinsicElement(wrapper, "." + DropdownSelectedItem_1.dropdownSelectedItemSlotClassNames.icon)
                .at(0)
                .simulate('click');
            expect(getSelectedItemNodes()).toHaveLength(1);
            expect(getSelectedItemNodeAtIndex(0)).toHaveTextContent(test_utils_2.items[1]);
    ...
    describe('searchQuery', function () {
        ...
        it('is set to empty when item is selected in multiple search', function () {
            var _a = test_utils_2.renderDropdown({
                ...
                multiple: true,
                defaultOpen: true,
            }), clickOnItemAtIndex = _a.clickOnItemAtIndex, searchInputNode = _a.searchInputNode, getSelectedItemNodes = _a.getSelectedItemNodes;
