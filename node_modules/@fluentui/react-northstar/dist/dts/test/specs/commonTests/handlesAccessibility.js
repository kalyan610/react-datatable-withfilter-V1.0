...
exports.getRenderedAttribute = function (renderedComponent, propName, partSelector) {
 ...
 */
exports.handlesAccessibility = function (Component, options) {
        ...
        test("handles \"onKeyDown\" overrides", function () {
            ...
            var actionBehavior = function () { return ({
                keyActions: {
                    root: {
                        mockAction: {
                            keyCombinations: [{ keyCode: keyboard_key_1.keyboardKey.Enter }],
                        },
                    },
                },
            }); };
            ...
            test_utils_1.act(function () {
                eventTarget_1.getEventTargetComponent(component, 'onKeyDown').simulate('keydown', {
                    keyCode: keyboard_key_1.keyboardKey.Enter,
                });
            });
