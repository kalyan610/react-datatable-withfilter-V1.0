...
exports.Dropdown = function (props) {
    ...
    setStart();
    var align = props.align, ariaLabelledby = props["aria-labelledby"], clearable = props.clearable, clearIndicator = props.clearIndicator, checkable = props.checkable, checkableIndicator = props.checkableIndicator, className = props.className, design = props.design, disabled = props.disabled, error = props.error, fluid = props.fluid, getA11ySelectionMessage = props.getA11ySelectionMessage, getA11yStatusMessage = props.getA11yStatusMessage, inline = props.inline, inverted = props.inverted, itemToString = props.itemToString, itemToValue = props.itemToValue, items = props.items, highlightFirstItemOnOpen = props.highlightFirstItemOnOpen, multiple = props.multiple, headerMessage = props.headerMessage, moveFocusOnTab = props.moveFocusOnTab, noResultsMessage = props.noResultsMessage, loading = props.loading, loadingMessage = props.loadingMessage, placeholder = props.placeholder, position = props.position, offset = props.offset, renderItem = props.renderItem, renderSelectedItem = props.renderSelectedItem, search = props.search, searchInput = props.searchInput, styles = props.styles, toggleIndicator = props.toggleIndicator, triggerButton = props.triggerButton, unstable_disableTether = props.unstable_disableTether, unstable_pinned = props.unstable_pinned, variables = props.variables;
    var _c = positioner_1.partitionPopperPropsFromShorthand(props.list), list = _c[0], positioningProps = _c[1];
    ...
    var renderItemsList = function (highlightedIndex, toggleMenu, selectItemAtIndex, getMenuProps, getItemProps, getInputProps) {
        ...
        return (React.createElement(react_component_ref_1.Ref, { innerRef: function (listElement) {
            ...
            React.createElement(positioner_1.Popper, tslib_1.__assign({ align: align, position: position, offset: offset, rtl: context.rtl, enabled: open, targetRef: containerRef, unstable_disableTether: unstable_disableTether, unstable_pinned: unstable_pinned, positioningDependencies: [items.length] }, positioningProps), List_1.List.create(list, {
    ...
    var handleStateChange = function (changes) {
        ...
        switch (type) {
            ...
            case downshift_1.default.stateChangeTypes.clickItem:
                ...
                if (multiple) {
                    setTimeout(function () { return (selectedItemsRef.current.scrollTop = selectedItemsRef.current.scrollHeight); }, 0);
                }
    ...
    var handleSearchInputOverrides = function (highlightedIndex, selectItemAtIndex, toggleMenu, accessibilityComboboxProps, getInputProps) { return function (predefinedProps) {
        ...
        var handleInputKeyDown = function (e, searchInputProps) {
            if (!disabled) {
                switch (keyboard_key_1.getCode(e)) {
                    // https://github.com/downshift-js/downshift/issues/1097
                    // Downshift skips Home/End if Deopdown is opened
                    case keyboard_key_1.keyboardKey.Home:
                        e.nativeEvent['preventDownshiftDefault'] = filteredItems.length === 0;
                        break;
                    case keyboard_key_1.keyboardKey.End:
                        e.nativeEvent['preventDownshiftDefault'] = filteredItems.length === 0;
                        break;
                    case keyboard_key_1.keyboardKey.Tab:
                        e.stopPropagation();
                        handleTabSelection(e, highlightedIndex, selectItemAtIndex, toggleMenu);
                        break;
                    case keyboard_key_1.keyboardKey.ArrowLeft:
                        e.stopPropagation();
                        if (!context.rtl) {
                            trySetLastSelectedItemAsActive();
                        }
                        break;
                    case keyboard_key_1.keyboardKey.ArrowRight:
                        e.stopPropagation();
                        if (context.rtl) {
                            trySetLastSelectedItemAsActive();
                        }
                        break;
                    case keyboard_key_1.keyboardKey.Backspace:
                        e.stopPropagation();
                        tryRemoveItemFromValue();
                        break;
                    case keyboard_key_1.keyboardKey.Escape:
    ...
    var handleSelectedItemKeyDown = function (e, item, predefinedProps, dropdownSelectedItemProps) {
        var previousKey = context.rtl ? keyboard_key_1.keyboardKey.ArrowRight : keyboard_key_1.keyboardKey.ArrowLeft;
        var nextKey = context.rtl ? keyboard_key_1.keyboardKey.ArrowLeft : keyboard_key_1.keyboardKey.ArrowRight;
        switch (keyboard_key_1.getCode(e)) {
            case keyboard_key_1.keyboardKey.Delete:
            case keyboard_key_1.keyboardKey.Backspace:
                handleSelectedItemRemove(e, item, predefinedProps, dropdownSelectedItemProps);
                break;
            case previousKey:
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({ className: classes.root, onBlur: handleOnBlur, onChange: handleChange }, unhandledProps, (process.env.NODE_ENV === 'test' && { 'data-test-focused': focused })),
        React.createElement(downshift_1.default, { isOpen: open, inputValue: search ? searchQuery : null, stateReducer: downshiftStateReducer, itemToString: itemToString, 
            ...
            }, getA11yStatusMessage: getA11yStatusMessage, highlightedIndex: highlightedIndex, onStateChange: handleStateChange, labelId: ariaLabelledby, environment: (_a = context.target) === null || _a === void 0 ? void 0 : _a.defaultView, inputId: searchInput && searchInput['id'] ? searchInput['id'] : undefined }, function (_a) {
