...
exports.Accordion = function (props) {
    ...
    var _b = react_bindings_1.useTelemetry(exports.Accordion.displayName, context.telemetry), setStart = _b.setStart, setEnd = _b.setEnd;
    setStart();
    ...
    }), activeIndex = _c[0], setActiveIndex = _c[1];
    var actionHandlers = {
        moveNext: function (e) {
            e.preventDefault();
    ...
    var _d = React.useState(), focusedIndex = _d[0], setfocusedIndex = _d[1];
    ...
    var itemRefs = React.useMemo(function () { var _a; return Array.from({ length: (_a = panels) === null || _a === void 0 ? void 0 : _a.length }, function () { return React.createRef(); }); }, 
    // As we are using "panels.length" it's fine to have dependency on them
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [(_a = panels) === null || _a === void 0 ? void 0 : _a.length]);
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign({ className: classes.root }, unhandledProps)), utils_1.rtlTextContainer.getAttributes({ forElements: [children] })), utils_1.childrenExist(children) ? children : renderPanels()));
    setEnd();
    return element;
};
exports.Accordion.displayName = 'Accordion';
exports.Accordion.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
