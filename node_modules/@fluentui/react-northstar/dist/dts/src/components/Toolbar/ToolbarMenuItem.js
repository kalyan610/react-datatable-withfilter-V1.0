...
exports.ToolbarMenuItem = react_bindings_1.compose(function (props, ref, composeOptions) {
    ...
    setStart();
    var active = props.active, activeIndicator = props.activeIndicator, children = props.children, content = props.content, disabled = props.disabled, submenuIndicator = props.submenuIndicator, icon = props.icon, popup = props.popup, wrapper = props.wrapper, inSubmenu = props.inSubmenu, className = props.className, design = props.design, styles = props.styles, variables = props.variables;
    ...
    var menuSlot = react_context_selector_1.useContextSelectors(toolbarMenuContext_1.ToolbarMenuContext, {
    ...
    var element = (React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign({ className: classes.root, onClick: handleClick, disabled: disabled,
        ref: ref }, unhandledProps))), utils_1.childrenExist(children) ? (children) : (React.createElement(React.Fragment, null,
    ...
    if (popup && !hasChildren) {
        var popupElement = utils_1.createShorthand(composeOptions.slots.popup, popup, {
            defaultProps: function () { return (tslib_1.__assign(tslib_1.__assign({}, slotProps.popup), { onOpenChange: function (e) {
                    e.stopPropagation();
                } })); },
            overrideProps: {
                trigger: element,
    ...
    var maybeSubmenu = menu && menuOpen ? (React.createElement(react_component_nesting_registry_1.Unstable_NestingAuto, null, function (getRefs, nestingRef) {
        return (React.createElement(React.Fragment, null,
            React.createElement(react_component_ref_1.Ref, { innerRef: function (node) {
                ...
                React.createElement(positioner_1.Popper, tslib_1.__assign({ align: "top", position: context.rtl ? 'before' : 'after', targetRef: itemRef }, menuPositioningProps),
                    React.createElement(toolbarVariablesContext_1.ToolbarVariablesProvider, { value: mergedVariables }, utils_1.createShorthand(composeOptions.slots.menu || menuSlot || ToolbarMenu_1.ToolbarMenu, menu, {
                        defaultProps: function () { return (tslib_1.__assign({ className: exports.toolbarMenuItemSlotClassNames.submenu, styles: resolvedStyles.menu, submenu: true, submenuIndicator: submenuIndicator }, slotProps.menu)); },
