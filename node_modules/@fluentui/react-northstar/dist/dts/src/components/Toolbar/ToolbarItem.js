...
exports.ToolbarItem = react_bindings_1.compose(function (props, ref, composeOptions) {
    ...
    setStart();
    var accessibility = props.accessibility, active = props.active, className = props.className, design = props.design, icon = props.icon, children = props.children, disabled = props.disabled, popup = props.popup, menuOpen = props.menuOpen, wrapper = props.wrapper, styles = props.styles, variables = props.variables;
    ...
    var itemElement = (React.createElement(react_component_ref_1.Ref, { innerRef: function (node) {
        ...
        React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign(tslib_1.__assign({}, unhandledProps), { disabled: disabled, className: classes.root, onBlur: handleBlur, onFocus: handleFocus, onClick: handleClick }))), utils_1.childrenExist(children) ? children : utils_1.createShorthand(composeOptions.slots.icon, icon, slotProps.icon))));
    var submenuElement = menuOpen ? (React.createElement(react_component_nesting_registry_1.Unstable_NestingAuto, null, function (getRefs, nestingRef) {
        return (React.createElement(React.Fragment, null,
            React.createElement(react_component_ref_1.Ref, { innerRef: function (node) {
                ...
                React.createElement(positioner_1.Popper, tslib_1.__assign({ align: "start", position: "above", targetRef: itemRef }, positioningProps),
...
exports.ToolbarItem.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon()), { active: PropTypes.bool, disabled: PropTypes.bool, icon: customPropTypes.shorthandAllowingChildren, menu: PropTypes.oneOfType([
