 ...
 */
exports.Menu = react_bindings_1.compose(function (props, ref, composeOptions) {
    var _a, _b;
    var context = react_bindings_1.useFluentContext();
    var _c = react_bindings_1.useTelemetry(composeOptions.displayName, context.telemetry), setStart = _c.setStart, setEnd = _c.setEnd;
    setStart();
    ...
    }), activeIndex = _d[0], setIndex = _d[1];
    ...
    var childProps = {
        ...
        behaviors: {
            item: (_a = childBehaviors) === null || _a === void 0 ? void 0 : _a.item,
            divider: (_b = childBehaviors) === null || _b === void 0 ? void 0 : _b.divider,
        },
        slots: {
