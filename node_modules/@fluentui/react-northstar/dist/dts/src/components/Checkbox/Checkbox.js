...
exports.Checkbox = function (props) {
    ...
    var _b = react_bindings_1.useStateManager(state_1.createCheckboxManager, {
        ...
        mapPropsToState: function () { return ({ checked: checked }); },
...
exports.Checkbox.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_1.commonPropTypes.createCommon({
    content: false,
})), { checked: PropTypes.bool, defaultChecked: PropTypes.bool, disabled: PropTypes.bool, indicator: customPropTypes.shorthandAllowingChildren, label: customPropTypes.itemShorthand, labelPosition: PropTypes.oneOf(['start', 'end']), onChange: PropTypes.func, onClick: PropTypes.func, toggle: PropTypes.bool });
