...
export declare type FormSliderStylesProps = never;
export declare const formSliderClassName = "ui-form__slider";
/**
 * An FormSlider renders a Slider wrapped by FormField.
 */
export declare const FormSlider: import("@fluentui/react-bindings").ComponentWithAs<"div", FormSliderProps & Pick<FormFieldBaseProps, "inline" | "label" | "className" | "message" | "errorMessage">>;
export {};
