...
export declare type FormCheckboxStylesProps = never;
export declare const formCheckboxClassName = "ui-form__checkbox";
/**
 * An FormCheckbox renders a Checkbox wrapped by FormField.
 */
export declare const FormCheckbox: import("@fluentui/react-bindings").ComponentWithAs<"div", FormCheckboxProps & Pick<FormFieldBaseProps, "inline" | "className" | "message" | "errorMessage">>;
export {};
