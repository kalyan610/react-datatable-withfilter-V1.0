...
export declare type FormDropdownStylesProps = never;
export declare const formDropdownClassName = "ui-form__dropdown";
/**
 * An FormDropdown renders a Dropdown wrapped by FormField.
 */
export declare const FormDropdown: import("@fluentui/react-bindings").ComponentWithAs<"div", DropdownProps & Pick<FormFieldBaseProps, "inline" | "label" | "className" | "message" | "errorMessage">>;
export {};
