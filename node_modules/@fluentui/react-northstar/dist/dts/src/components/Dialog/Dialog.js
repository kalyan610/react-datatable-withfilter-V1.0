...
exports.Dialog = function (props) {
    ...
    contentId.current = utils_2.getOrGenerateIdFromShorthand('dialog-content-', content, contentId.current);
    var headerId = React.useRef();
    headerId.current = utils_2.getOrGenerateIdFromShorthand('dialog-header-', header, headerId.current);
    ...
    React.useEffect(function () {
        if (open) {
            utils_1.lockBodyScroll(context.target);
        }
        return function () {
            if (open) {
                utils_1.unlockBodyScroll(context.target);
            }
        };
    }, [context.target, open]);
    ...
    var handleOverlayClick = function (e) {
        ...
        // refs
        var isInsideContentClick = utils_2.doesNodeContainClick(contentRef.current, e, context.target);
        var isInsideOverlayClick = utils_2.doesNodeContainClick(overlayRef.current, e, context.target);
    ...
    var handleDocumentKeydown = function (getRefs) { return function (e) {
        ...
        if (targetIsBody && keyboard_key_1.getCode(e) === keyboard_key_1.keyboardKey.Escape && isLastOpenedDialog) {
            handleDialogCancel(e);
            _.invoke(triggerRef, 'current.focus');
        }
    }; };
    var cancelElement = utils_2.createShorthand(Button_1.Button, cancelButton, {
        overrideProps: handleCancelButtonOverrides,
    });
    var confirmElement = utils_2.createShorthand(Button_1.Button, confirmButton, {
    ...
    var dialogContent = (React.createElement(react_component_ref_1.Ref, { innerRef: contentRef },
        React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('popup', tslib_1.__assign({ className: classes.root }, unhandledProps))),
            ...
            utils_2.createShorthand(Button_1.Button, headerAction, {
                defaultProps: function () {
...
exports.Dialog.propTypes = tslib_1.__assign(tslib_1.__assign({}, utils_2.commonPropTypes.createCommon({
    children: false,
    content: 'shorthand',
...
exports.Dialog.create = utils_2.createShorthandFactory({
