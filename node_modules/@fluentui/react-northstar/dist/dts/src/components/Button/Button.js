...
exports.Button = react_bindings_1.compose(function (props, ref, composeOptions) {
    ...
    var result = (React.createElement(ElementType, tslib_1.__assign({}, utils_1.rtlTextContainer.getAttributes({ forElements: [children] }), getA11yProps('root', tslib_1.__assign({ onClick: handleClick, disabled: disabled, className: classes.root, onFocus: handleFocus, ref: ref }, unhandledProps))), hasChildren ? (children) : (React.createElement(React.Fragment, null,
