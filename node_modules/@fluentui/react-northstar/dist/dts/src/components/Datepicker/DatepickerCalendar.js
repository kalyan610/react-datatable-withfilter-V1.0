...
exports.DatepickerCalendar = function (props) {
        ...
        return utils_1.createShorthand(DatepickerCalendarCell_1.DatepickerCalendarCell, calendarCell, {
            defaultProps: function () {
                ...
                return getA11yProps('calendarCell', {
                    ...
                    quiet: !day.isInMonth,
                    today: date_time_utilities_1.compareDates(day.originalDate, (_a = props.today, (_a !== null && _a !== void 0 ? _a : new Date()))),
                });
            },
        });
    };
    var renderCellButton = function (day) {
        return utils_1.createShorthand(DatepickerCalendarCellButton_1.DatepickerCalendarCellButton, calendarCellButton, {
            ...
            overrideProps: function (predefinedProps) { return ({
                ...
                onClick: function (e) {
                    _.invoke(props, 'onDateChange', e, tslib_1.__assign(tslib_1.__assign({}, props), { value: day }));
    ...
    var renderWeekRow = function (week) { return _.map(week, function (day) { return renderCell(day, renderCellButton(day)); }); };
