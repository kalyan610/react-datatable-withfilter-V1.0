...
exports.contstraintNavigatedDate = function (initialDate, targetDate, direction, restrictedDatesOptions, navigateToDisabledDates) {
    if (!targetDate) {
...
exports.navigateToNewDate = function (originalDate, kind, step, restrictedDatesOptions, navigateToDisabledDates) {
    var targetDate = null;
