...
exports.Datepicker = function (props) {
    ...
    var calendar = props.calendar, popup = props.popup, input = props.input, className = props.className, design = props.design, styles = props.styles, variables = props.variables, formatMonthDayYear = props.formatMonthDayYear, allowManualInput = props.allowManualInput;
    var valueFormatter = function (date) { return (date ? formatMonthDayYear(date, dateFormatting) : ''); };
    ...
    var element = getA11yProps.unstable_wrapWithFocusZone(React.createElement(ElementType, tslib_1.__assign({}, getA11yProps('root', tslib_1.__assign({ className: classes.root }, unhandledProps))),
        ...
        utils_1.createShorthand(Popup_1.Popup, popup, {
            ...
            overrideProps: function (predefinedProps) {
                var _a;
                return ({
                    trigger: (_a = predefinedProps.trigger, (_a !== null && _a !== void 0 ? _a : triggerButtonElement)),
                    ...
                    onOpenChange: function (e, _a) {
                        ...
                        if (!(e.type === 'click' && e.target === ((_b = inputRef) === null || _b === void 0 ? void 0 : _b.current))) {
                            setOpenState(open);
