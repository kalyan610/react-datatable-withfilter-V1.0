...
exports.Carousel = function (props) {
    ...
    var _b = react_bindings_1.useTelemetry(exports.Carousel.displayName, context.telemetry), setStart = _b.setStart, setEnd = _b.setEnd;
    setStart();
    ...
    var _c = react_bindings_1.useStateManager(state_1.createCarouselManager, {
    ...
    var itemRefs = React.useMemo(function () { var _a; return Array.from({ length: (_a = items) === null || _a === void 0 ? void 0 : _a.length }, function () { return React.createRef(); }); }, 
    // As we are using "panels.length" it's fine to have dependency on them
    // eslint-disable-next-line react-hooks/exhaustive-deps
    [(_a = items) === null || _a === void 0 ? void 0 : _a.length]);
    ...
    var renderNavigation = function () {
        ...
        })) : getItemPositionText ? (React.createElement(Text_1.Text, { "aria-hidden": "true", className: exports.carouselSlotClassNames.pagination, content: getItemPositionText(+activeIndex, items.length) })) : null;
    };
