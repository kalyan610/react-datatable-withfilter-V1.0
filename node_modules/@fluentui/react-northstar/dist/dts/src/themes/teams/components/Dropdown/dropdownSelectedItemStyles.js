...
exports.dropdownSelectedItemStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ display: 'inline-flex', alignItems: 'center', 
            // overflow: 'hidden',
            padding: "0 " + utils_1.pxToRem(4) + " 0 " + utils_1.pxToRem(4), startPaddingLeft: '0px', lineHeight: utils_1.pxToRem(20), borderRadius: utils_1.pxToRem(9999), fontSize: utils_1.pxToRem(14) }, (p.hasImage && { paddingLeft: '0px' })), { cursor: 'pointer', margin: '.25rem 0 0 .4rem', color: v.selectedItemColor, position: 'relative', border: v.selectedItemBorder, height: utils_1.pxToRem(24), overflow: 'visible', outline: 0, fontWeight: siteVariables.fontWeightSemibold }), (v.selectedItemBackgroundColor && {
    ...
    header: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign({}, (p.hasImage && { marginLeft: utils_1.pxToRem(3) })), { marginRight: utils_1.pxToRem(3) });
    },
    icon: function (_a) {
        var v = _a.variables;
        return (tslib_1.__assign(tslib_1.__assign({ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', width: utils_1.pxToRem(16), height: utils_1.pxToRem(16), '& > :first-child': {
                height: '100%',
                width: '100%',
                '& svg': {
                    height: '100%',
