...
exports.splitButtonVariables = function (siteVars) {
    return {
        ...
        smallDimension: utils_1.pxToRem(24),
        smallPadding: "0 " + utils_1.pxToRem(8),
        smallMinWidth: '0',
        smallBoxShadow: 'none',
        padding: "0 " + utils_1.pxToRem(12),
        minWidth: '0',
        toggleButtonHeight: utils_1.pxToRem(32),
        ...
        toggleButtonIndicatorSize: utils_1.pxToRem(16),
