...
exports.sliderVariables = function (siteVars) {
    ...
    return {
        ...
        thumbHeight: utils_1.pxToRem(10),
        activeThumbHeight: utils_1.pxToRem(14),
        thumbBorderPadding: utils_1.pxToRem(4),
        thumbWidth: utils_1.pxToRem(10),
        activeThumbWidth: utils_1.pxToRem(14),
