...
exports.checkboxStyles = {
    root: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ position: 'relative', display: ['inline-grid', '-ms-inline-grid'], gridTemplateColumns: "auto " + v.gap + " 1fr", 
    ...
    checkbox: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ msGridRowAlign: 'center', gridColumn: 1, msGridColumn: 1 }, (p.labelPosition === 'start' && {
            gridColumn: 3,
            msGridColumn: 3,
    ...
    label: function (_a) {
        var p = _a.props;
        return (tslib_1.__assign({ display: 'block', gridColumn: 3, msGridColumn: 3 }, (p.labelPosition === 'start' && {
            gridColumn: 1,
            msGridColumn: 1,
        })));
    },
