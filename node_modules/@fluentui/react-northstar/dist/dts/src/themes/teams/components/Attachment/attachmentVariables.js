...
exports.attachmentVariables = function (siteVariables) { return ({
    padding: utils_1.pxToRem(7) + " " + utils_1.pxToRem(3) + " " + utils_1.pxToRem(7) + " " + utils_1.pxToRem(11),
    iconSpace: utils_1.pxToRem(12),
    iconSize: utils_1.pxToRem(32),
    ...
    progressHeight: utils_1.pxToRem(4),
    ...
    // action variables
    actionHeight: utils_1.pxToRem(32),
    actionMaxWidth: utils_1.pxToRem(280),
    ...
    actionIconSize: utils_1.pxToRem(16),
    actionLoaderBorderSize: utils_1.pxToRem(2),
    actionLoaderSize: utils_1.pxToRem(20),
    actionLoaderSvgHeight: utils_1.pxToRem(1220),
    actionLoaderSvgAnimationHeight: utils_1.pxToRem(-1200),
    actionFocusBorderRadius: utils_1.pxToRem(3),
}); };
