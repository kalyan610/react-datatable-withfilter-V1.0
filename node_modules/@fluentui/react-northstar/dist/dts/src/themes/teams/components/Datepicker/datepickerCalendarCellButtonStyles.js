...
exports.datepickerCalendarCellButtonStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ textAlign: 'center', height: '100%', width: '100%', borderRadius: v.calendarCellBorderRadius, cursor: 'pointer', border: v.calendarCellBorder, padding: v.calendarCellPadding, margin: v.calendarCellMargin, display: 'table-cell', position: 'relative' }, borderFocusStyles), { backgroundColor: v.calendarCellBackgroundColor, color: v.calendarCellColor, ':hover': {
