...
exports.buttonVariables = function (siteVars) { return ({
    padding: "0 " + utils_1.pxToRem(20),
    height: utils_1.pxToRem(32),
    minWidth: utils_1.pxToRem(96),
    loadingMinWidth: utils_1.pxToRem(118),
    maxWidth: utils_1.pxToRem(280),
    ...
    circularBorderRadius: utils_1.pxToRem(999),
    ...
    loaderBorderSize: utils_1.pxToRem(2),
    loaderSize: utils_1.pxToRem(20),
    loaderSvgHeight: utils_1.pxToRem(1220),
    loaderSvgAnimationHeight: utils_1.pxToRem(-1200),
    sizeSmallContentFontSize: siteVars.fontSizes.small,
    sizeSmallContentLineHeight: siteVars.lineHeightSmall,
    sizeSmallHeight: utils_1.pxToRem(24),
    sizeSmallMinWidth: utils_1.pxToRem(72),
    sizeSmallPadding: "0 " + utils_1.pxToRem(8),
    sizeSmallLoaderBorderSize: utils_1.pxToRem(2),
    sizeSmallLoaderSize: utils_1.pxToRem(15),
    sizeSmallLoaderSvgHeight: utils_1.pxToRem(895),
    sizeSmallLoaderSvgAnimationHeight: utils_1.pxToRem(-880),
}); };
