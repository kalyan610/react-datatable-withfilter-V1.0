...
exports.textStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, (p.color && { color: colors.foreground })), (p.atMention === true && { color: v.atMentionOtherColor })), (p.truncated && { overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' })), (p.disabled && { color: v.disabledColor })), (p.error && { color: v.errorColor })), (p.success && { color: v.successColor })), (p.temporary && { fontStyle: 'italic' })), (p.align && { display: 'block', textAlign: translateAlignProp_1.translateAlignProp(p.align) })), (p.weight === 'light' && { fontWeight: v.fontWeightLight })), (p.weight === 'semilight' && { fontWeight: v.fontWeightSemilight })), (p.weight === 'regular' && { fontWeight: v.fontWeightRegular })), (p.weight === 'semibold' && { fontWeight: v.fontWeightSemibold })), (p.weight === 'bold' && { fontWeight: v.fontWeightBold })), (p.size === 'smallest' && {
