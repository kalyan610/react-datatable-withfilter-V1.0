...
exports.cardStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ display: 'flex', flexDirection: 'column', position: 'relative', padding: v.padding, margin: v.margin, width: v.width, height: v.height, borderWidth: v.borderWidth, borderStyle: v.borderStyle, borderColor: v.borderColor, borderRadius: v.borderRadius, backgroundColor: v.backgroundColor }, (p.quiet && {
        ...
        })), { ':hover': tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ backgroundColor: v.backgroundColorHover }, (p.quiet && {
            ...
            cursor: 'pointer',
            ':focus-visible': tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ backgroundColor: v.backgroundColorFocus }, (p.quiet && {
            ...
            ':active': tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ backgroundColor: v.backgroundColorPressed }, (p.quiet && {
            ...
            }, ':focus-visible': tslib_1.__assign({ boxShadow: v.boxShadowDisabled }, borderFocusStyles[':focus-visible']), ':active': {
                boxShadow: v.boxShadowDisabled,
            } }))), (p.expandable && (_b = {},
