...
exports.getFocusedStyles = function (_a) {
...
exports.pointingBeak = function (_a) {
    var props = _a.props, v = _a.variables, colors = _a.colors;
...
exports.menuItemStyles = {
    root: function (_a) {
        ...
        return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ color: 'inherit', display: 'block', cursor: 'pointer', whiteSpace: 'nowrap', overflow: 'hidden' }, (pointing &&
            ...
            overflow: 'visible',
        })), (active && tslib_1.__assign(tslib_1.__assign({}, (iconOnly && tslib_1.__assign({ color: v.iconOnlyColorActive }, getIconFillOrOutlineStyles_1.getIconFillOrOutlineStyles({ outline: false })))), (underlined && tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({ color: v.activeUnderlinedColor }, exports.underlinedItem(v.activeUnderlinedBorderBottomColor)), (primary && tslib_1.__assign({ color: v.activeUnderlinedPrimaryColor }, exports.underlinedItem(v.borderColorActive || colors.borderActive)))), (!primary && { fontWeight: 700 })))))), (isFromKeyboard && tslib_1.__assign(tslib_1.__assign({ color: 'inherit' }, (iconOnly && tslib_1.__assign({ borderRadius: '50%', borderColor: v.iconOnlyColorFocus }, getIconFillOrOutlineStyles_1.getIconFillOrOutlineStyles({ outline: false })))), (primary
