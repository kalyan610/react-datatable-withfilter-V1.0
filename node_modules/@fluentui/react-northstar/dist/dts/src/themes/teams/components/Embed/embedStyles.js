...
exports.embedStyles = {
    ...
    control: function (_a) {
        ...
        return (tslib_1.__assign(tslib_1.__assign({ background: "0 no-repeat " + v.controlBackgroundColor, backgroundPositionX: utils_1.pxToRem(3), width: utils_1.pxToRem(48), height: utils_1.pxToRem(48), color: v.controlColor, padding: utils_1.pxToRem(4), borderRadius: '50%', backgroundImage: playIndicatorUrl_1.playIndicatorUrl(v.controlColor), backgroundRepeat: 'no-repeat', backgroundPosition: 'center' }, (p.active && {
