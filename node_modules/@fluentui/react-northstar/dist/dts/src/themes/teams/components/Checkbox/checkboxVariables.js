...
var toggleMovementDistance = utils_1.pxToRem(20);
var padding = utils_1.pxToRem(2);
var defaultValue = 'red';
exports.checkboxVariables = function (siteVars) { return ({
    checkboxColor: 'transparent',
    toggleBackground: 'transparent',
    toggleBorderColor: siteVars.colors.grey[300],
    toggleBorderStyle: "solid",
    toggleBorderWidth: utils_1.pxToRem(1),
    ...
    gap: utils_1.pxToRem(12),
    margin: utils_1.pxToRem(2.8) + " 0 0 0",
    padding: padding,
    rootPadding: '3px 5px',
    ...
    toggleBorderRadius: utils_1.pxToRem(999),
    toggleIndicatorSize: utils_1.pxToRem(14),
    toggleMargin: '0',
    togglePadding: padding + " " + toggleMovementDistance + " " + padding + " " + padding,
    toggleWidth: utils_1.pxToRem(38),
    toggleHeight: utils_1.pxToRem(20),
