...
exports.datepickerVariables = function (siteVars) { return ({
    calendarCellBorder: 'none',
    calendarCellHeight: utils_1.pxToRem(32),
    calendarCellWidth: utils_1.pxToRem(32),
    calendarCellBorderRadius: utils_1.pxToRem(2),
    calendarCellPadding: utils_1.pxToRem(0),
    calendarCellMargin: utils_1.pxToRem(0),
    ...
    calendarHeaderCellHeight: utils_1.pxToRem(32),
    calendarHeaderCellPadding: utils_1.pxToRem(2) + " " + utils_1.pxToRem(0) + " " + utils_1.pxToRem(2) + " " + utils_1.pxToRem(0),
    calendarHeaderCellWidth: "calc(100%/" + date_time_utilities_1.DAYS_IN_WEEK + ")",
    calendarHeaderPaddingTop: utils_1.pxToRem(5),
    calendarHeaderPaddingBottom: utils_1.pxToRem(5),
    calendarHeaderLabelPaddingLeft: utils_1.pxToRem(10),
    calendarHeaderLabelFontWeight: siteVars.fontWeightBold,
    calendarMinHeight: utils_1.pxToRem(282),
}); };
