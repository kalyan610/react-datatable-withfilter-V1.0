...
exports.tableVariables = function (siteVariables) {
    return {
        ...
        defaultRowHeight: utils_1.pxToRem(48),
        compactRowHeight: utils_1.pxToRem(36),
        minCellWidth: '0',
        cellPadding: "0 " + utils_1.pxToRem(8),
        rowPadding: '0',
        headerFontSize: utils_1.pxToRem(12),
        bodyFontSize: utils_1.pxToRem(13),
