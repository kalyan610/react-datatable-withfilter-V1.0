import { ColorPalette, PrimitiveColors, ColorSchemeMapping, ColorScheme, StrictColorSchemeMapping } from '../types';
...
export declare const getColorScheme: <T extends string>(colorScheme: StrictColorSchemeMapping<Record<T, string>, "black" | "green" | "grey" | "orange" | "pink" | "red" | "silver" | "white" | "yellow" | "ruby" | "brand" | "onyx" | "amethyst">, color?: string, primary?: boolean) => Record<T, string>;
