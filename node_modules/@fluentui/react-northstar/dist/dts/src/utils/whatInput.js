 ...
 * set up for document
 */
exports.setUpWhatInput = function (target) {
...
exports.tryCleanupWhatInput = function (target) {
    var targetWindow = target.defaultView;
...
exports.setWhatInputSource = function (target, newInput) {
    currentInput = newInput;
    doUpdate(target);
};
// returns string: the current input type
// returns the same value as the `data-whatinput` attribute
exports.ask = function () { return currentInput; };
exports.isFromKeyboard = function () { return exports.ask() === 'keyboard'; };
