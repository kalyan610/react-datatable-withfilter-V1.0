...
export declare const textColorAreas: "foreground"[];
export declare type TextColorSchemeMapping = TeamsSchemeMappingWithAreas<ItemType<typeof textColorAreas>>;
...
export declare const textVariables: (siteVariables: any) => TextVariables;
