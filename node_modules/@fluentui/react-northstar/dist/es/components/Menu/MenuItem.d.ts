import { Accessibility, MenuItemBehaviorProps } from '@fluentui/accessibility';
...
export interface MenuItemProps extends UIComponentProps, ChildrenComponentProps, ContentComponentProps<ShorthandValue<MenuItemContentProps>> {
    /**
...
export declare type MenuItemStylesProps = Required<Pick<MenuItemProps, 'primary' | 'underlined' | 'active' | 'vertical' | 'pointing' | 'secondary' | 'disabled' | 'iconOnly' | 'pills' | 'inSubmenu'>> & {
    isFromKeyboard: boolean;
};
export declare type MenuItemState = {
    isFromKeyboard: boolean;
    menuOpen: boolean;
};
 ...
 */
export declare const MenuItem: (<TExtendedElementType extends React.ElementType<any> = "a">(props: Pick<import("@fluentui/react-bindings").PropsOfElement<TExtendedElementType>, Exclude<keyof import("@fluentui/react-bindings").PropsOfElement<TExtendedElementType>, "content" | "vertical" | "icon" | "menu" | "active" | "disabled" | "children" | "as" | "className" | "onFocus" | "onBlur" | "onClick" | "design" | "styles" | "variables" | "accessibility" | "primary" | "secondary" | "index" | "indicator" | "iconOnly" | "inSubmenu" | "underlined" | "pills" | "pointing" | "itemPosition" | "itemsCount" | "wrapper" | "menuOpen" | "defaultMenuOpen" | "onActiveChanged" | "onMenuOpenChange">> & {
