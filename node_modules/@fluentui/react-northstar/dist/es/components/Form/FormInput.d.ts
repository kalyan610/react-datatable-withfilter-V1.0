 ...
 */
export declare const FormInput: import("@fluentui/react-bindings").ComponentWithAs<"input", FormInputProps & Pick<FormFieldBaseProps, "inline" | "className" | "message" | "errorMessage">>;
export {};
