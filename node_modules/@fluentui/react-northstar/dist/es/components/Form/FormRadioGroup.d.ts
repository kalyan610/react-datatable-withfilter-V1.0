...
export declare type FormRadioGroupStylesProps = never;
export declare const formRadioGroupClassName = "ui-forms";
/**
 * An FormRadioGroup renders a RadioGroup wrapped by FormField.
 */
export declare const FormRadioGroup: import("@fluentui/react-bindings").ComponentWithAs<"div", FormRadioGroupProps & Pick<FormFieldBaseProps, "inline" | "label" | "className" | "message" | "errorMessage">>;
export {};
