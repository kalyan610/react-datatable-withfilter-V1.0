 ...
 */
export declare const FormButton: import("@fluentui/react-bindings").ComponentWithAs<"div", FormButtonProps & Pick<FormFieldBaseProps, "inline" | "label" | "className" | "message" | "errorMessage">>;
export {};
