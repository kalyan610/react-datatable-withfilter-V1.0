...
describe('FocusZone', function () {
    ...
    it('can use arrows vertically', function () {
        ...
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.ArrowDown });
        ...
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.ArrowUp });
        expect(lastFocusedElement).toBe(buttonB);
        ...
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.ArrowLeft });
        expect(lastFocusedElement).toBe(buttonB);
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.ArrowRight });
        expect(lastFocusedElement).toBe(buttonB);
        // Press home should go to the first target.
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.Home });
        expect(lastFocusedElement).toBe(buttonA);
        // Press end should go to the last target.
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.End });
        expect(lastFocusedElement).toBe(buttonC);
    });
    it('can ignore arrowing if default is prevented', function () {
        ...
        ReactTestUtils.Simulate.keyDown(focusZone, {
            which: keyboard_key_1.keyboardKey.ArrowDown,
    ...
    it('skips subzone elements until manually entered', function () {
        var _a;
        var shouldEnterInnerZone = function (e) { return keyboard_key_1.getCode(e) === keyboard_key_1.keyboardKey.Enter; };
        ...
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.ArrowLeft });
        expect(lastFocusedElement).toBe(divB);
        ReactTestUtils.Simulate.keyDown(divB, { which: keyboard_key_1.keyboardKey.Enter });
        expect(lastFocusedElement).toBe(buttonB);
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.ArrowRight });
        expect(lastFocusedElement).toBe(buttonC);
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.ArrowLeft });
    ...
    it('removes tab-index of previous element when another one is selected (mouse & keyboard)', function () {
        ...
        // Pressing right should go to b.
        ReactTestUtils.Simulate.keyDown(focusZoneElement, { which: keyboard_key_1.keyboardKey.ArrowRight });
        expect(lastFocusedElement).toBe(buttonB);
    ...
    it('Changes our focus to the next button when we hit tab when focus zone allow tabbing', function () {
        ...
        ReactTestUtils.Simulate.keyDown(focusZone, { which: keyboard_key_1.keyboardKey.Tab });
        expect(lastFocusedElement).toBe(buttonB);
        expect(buttonA.tabIndex).toBe(-1);
        expect(buttonB.tabIndex).toBe(0);
        expect(buttonC.tabIndex).toBe(-1);
    ...
    it('detects tab when our focus zone does not allow tabbing', function () {
        ...
        expect(keyboard_key_1.getCode(onKeyDownEvent)).toBe(keyboard_key_1.keyboardKey.Tab);
    });
    it('should stay in input box with arrow keys and exit with tab', function () {
        ...
        ReactTestUtils.Simulate.keyDown(inputA, { which: keyboard_key_1.keyboardKey.Tab });
        expect(lastFocusedElement).toBe(buttonB);
    ...
    it('remains focus in element with "contenteditable=true" attribute on Home/End keys', function () {
        ...
        ReactTestUtils.Simulate.keyDown(contentEditableA, { which: keyboard_key_1.keyboardKey.Home });
        expect(lastFocusedElement).toBe(contentEditableA);
        ReactTestUtils.Simulate.keyDown(contentEditableA, { which: keyboard_key_1.keyboardKey.End });
        expect(lastFocusedElement).toBe(contentEditableA);
    ...
    it('should call onKeyDown handler even within another FocusZone', function () {
        ...
        ReactTestUtils.Simulate.keyDown(innerFocusZone, { which: keyboard_key_1.keyboardKey.Enter });
    ...
    it('only adds outerzones to be updated for tab changes', function () {
        var activeZones = react_bindings_1.FocusZone.getOuterZones();
        ...
        expect(react_bindings_1.FocusZone.getOuterZones()).toEqual(activeZones + 1);
        ReactDOM.unmountComponentAtNode(host);
        expect(react_bindings_1.FocusZone.getOuterZones()).toEqual(activeZones);
    });
