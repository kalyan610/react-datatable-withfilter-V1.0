...
exports.getAccessibility = function (displayName, behavior, behaviorProps, isRtlEnabled, actionHandlers) {
    ...
    if (definition.focusZone) {
        definition.focusZone.props = tslib_1.__assign({ 
    ...
    return tslib_1.__assign(tslib_1.__assign(tslib_1.__assign({}, emptyBehavior), definition), { keyHandlers: keyHandlers });
};
