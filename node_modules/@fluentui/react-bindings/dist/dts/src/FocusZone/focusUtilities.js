...
exports.IS_VISIBLE_ATTRIBUTE = 'data-is-visible';
exports.FOCUSZONE_ID_ATTRIBUTE = 'data-focuszone-id';
exports.FOCUSZONE_SUB_ATTRIBUTE = 'data-is-sub-focuszone';
exports.HIDDEN_FROM_ACC_TREE = 'data-is-hidden-from-acc-tree';
var utilities_2 = require("@uifabric/utilities");
exports.getDocument = utilities_2.getDocument;
exports.getParent = utilities_2.getParent;
exports.getWindow = utilities_2.getWindow;
/**
...
function isElementVisible(element) {
    ...
    var visibilityAttribute = element.getAttribute(exports.IS_VISIBLE_ATTRIBUTE);
...
function isElementTabbable(element, checkTabIndex) {
    ...
    var isFocusableAttribute = element.getAttribute ? element.getAttribute(accessibility_1.IS_FOCUSABLE_ATTRIBUTE) : null;
...
function isElementFocusZone(element) {
    return !!(element && element.getAttribute && !!element.getAttribute(exports.FOCUSZONE_ID_ATTRIBUTE));
}
...
function isElementFocusSubZone(element) {
    return !!(element && element.getAttribute && element.getAttribute(exports.FOCUSZONE_SUB_ATTRIBUTE) === 'true');
}
...
function focusAsync(element) {
    if (element) {
        ...
        targetToFocusOnNextRepaint = element;
        var win = utilities_1.getWindow(element);
        if (win) {
...
function getElementIndexPath(fromElement, toElement) {
    ...
    while (currentElement && fromElement && currentElement !== fromElement) {
        var parent_1 = utilities_1.getParent(currentElement, false);
        if (parent_1 === null) {
            return [];
        }
        path.unshift(Array.prototype.indexOf.call(parent_1.children, currentElement));
