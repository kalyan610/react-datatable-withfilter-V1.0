...
function _onKeyDownCapture(ev) {
    if (keyboard_key_1.getCode(ev) === keyboard_key_1.keyboardKey.Tab) {
        _outerZones.forEach(function (zone) { return zone.updateTabIndexes(); });
    }
}
var FocusZone = /** @class */ (function (_super) {
    ...
    function FocusZone(props) {
        ...
        _this._onFocus = function (ev) {
            var _a = _this.props, onActiveElementChanged = _a.onActiveElementChanged, stopFocusPropagation = _a.stopFocusPropagation, shouldFocusInnerElementWhenReceivedFocus = _a.shouldFocusInnerElementWhenReceivedFocus, defaultTabbableElement = _a.defaultTabbableElement;
        ...
        _this._onKeyDown = function (ev) {
            ...
            if (shouldEnterInnerZone &&
                ...
                switch (keyboard_key_1.getCode(ev)) {
                    case keyboard_key_1.SpacebarKey:
                        // @ts-ignore
                    ...
                    case keyboard_key_1.keyboardKey.ArrowRight:
                        ...
                        return undefined;
                    case keyboard_key_1.keyboardKey.ArrowUp:
                        ...
                        return undefined;
                    case keyboard_key_1.keyboardKey.ArrowDown:
                        if (direction !== accessibility_1.FocusZoneDirection.horizontal) {
                            _this.preventDefaultWhenHandled(ev);
                        ...
                        return undefined;
                    case keyboard_key_1.keyboardKey.PageDown:
                        if (!pagingSupportDisabled && _this.moveFocusPaging(true)) {
                            break;
                        }
                        return undefined;
                    case keyboard_key_1.keyboardKey.PageUp:
                    ...
                    case keyboard_key_1.keyboardKey.End:
                        ...
                        return undefined;
                    case keyboard_key_1.keyboardKey.Enter:
                        // @ts-ignore
                        if (_this.tryInvokeClickForFocusable(ev.target)) {
                            break;
                        }
    ...
    FocusZone.prototype.setActiveElement = function (element, forceAlignemnt) {
