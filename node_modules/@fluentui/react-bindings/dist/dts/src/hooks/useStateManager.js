...
exports.useStateManager = function (managerFactory, options) {
    ...
    latestManager.current = managerFactory({
        ...
        actions: {},
        state: tslib_1.__assign(tslib_1.__assign({}, initialState), getDefinedProps(mapPropsToState())),
        sideEffects: tslib_1.__spreadArrays(sideEffects, [
