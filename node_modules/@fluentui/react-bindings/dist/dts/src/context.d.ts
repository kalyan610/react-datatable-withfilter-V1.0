...
export declare type ProviderContextInput = {
    rtl?: boolean;
...
export declare type ProviderContextPrepared = {
    rtl: boolean;
    disableAnimations: boolean;
...
export declare const defaultPerformanceFlags: StylesContextPerformance;
export declare function useFluentContext(): ProviderContextPrepared;
export declare const Unstable_FluentContextProvider: React.Provider<ProviderContextPrepared>;
