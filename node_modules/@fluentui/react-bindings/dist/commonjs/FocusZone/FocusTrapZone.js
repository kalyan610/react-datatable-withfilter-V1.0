...
var FocusTrapZone = /*#__PURE__*/function (_React$Component) {
  (0, _inheritsLoose2.default)(FocusTrapZone, _React$Component);
  ...
  function FocusTrapZone() {
    ...
    _this.createRef = function (elem) {
      ...
      _this.windowRef.current = (0, _focusUtilities.getWindow)(_this._root.current);
    };
    ...
    _this._onRootBlur = function (ev) {
      ...
      if (ev.relatedTarget === null) {
        ...
        // on the event
        var doc = (0, _focusUtilities.getDocument)(_this._root.current); // @ts-ignore
    ...
    _this._onBumperFocus = function (isFirstBumper) {
      ...
      var nextFocusable = isFirstBumper === _this._hasFocus ? (0, _focusUtilities.getLastTabbable)(_this._root.current, currentBumper, true, false) : (0, _focusUtilities.getFirstTabbable)(_this._root.current, currentBumper, true, false);
    ...
    _this._enableFocusTrapZone = function () {
      ...
      FocusTrapZone._focusStack.push((0, _assertThisInitialized2.default)(_this));
    ...
    _this._releaseFocusTrapZone = function () {
      ...
      FocusTrapZone._focusStack = FocusTrapZone._focusStack.filter(function (value) {
        return (0, _assertThisInitialized2.default)(_this) !== value;
      ...
      } else if (lastActiveFocusTrap._root.current && lastActiveFocusTrap._root.current.hasAttribute(_focusUtilities.HIDDEN_FROM_ACC_TREE)) {
        lastActiveFocusTrap._root.current.removeAttribute(_focusUtilities.HIDDEN_FROM_ACC_TREE);
    ...
    _this._findElementAndFocusAsync = function () {
      ...
      if (!firstFocusableChild) {
        firstFocusableChild = (0, _focusUtilities.getNextElement)(_this._root.current, _this._root.current.firstChild, false, false, false, true);
      }
    ...
    _this._forceFocusInTrap = function (ev, triggeredElement) {
      if (FocusTrapZone._focusStack.length && (0, _assertThisInitialized2.default)(_this) === FocusTrapZone._focusStack[FocusTrapZone._focusStack.length - 1]) {
        // @ts-ignore
    ...
    _this._hideContentFromAccessibilityTree = function () {
      ...
      for (var index = 0; index < bodyChildren.length; index++) {
        ...
        if (!isOrHasFocusTrapZone && !isAriaLiveRegion && currentChild.getAttribute('aria-hidden') !== 'true') {
          ...
          currentChild.setAttribute(_focusUtilities.HIDDEN_FROM_ACC_TREE, 'true');
        }
      }
    };
    ...
    _this._showContentInAccessibilityTree = function () {
      ...
      var hiddenElements = doc.querySelectorAll("[" + _focusUtilities.HIDDEN_FROM_ACC_TREE + "=\"true\"]");

      for (var index = 0; index < hiddenElements.length; index++) {
        var element = hiddenElements[index];
        element.removeAttribute('aria-hidden');
        element.removeAttribute(_focusUtilities.HIDDEN_FROM_ACC_TREE);
      }
    };
  ...
  _proto.componentDidUpdate = function componentDidUpdate(prevProps) {
    ...
    var doc = (0, _focusUtilities.getDocument)(this._root.current); // @ts-ignore
  ...
  _proto.componentWillUnmount = function componentWillUnmount() {
    ...
    var doc = (0, _focusUtilities.getDocument)(this._root.current);
  ...
  _proto.render = function render() {
    ...
    var unhandledProps = (0, _getUnhandledProps.getUnhandledProps)((0, _keys2.default)(FocusTrapZone.propTypes), this.props);
    ...
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(ElementType, (0, _extends2.default)({}, unhandledProps, {
      className: className,
      ref: this.createRef,
    ...
    }), /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, bumperProps, {
      ref: this._firstBumper,
      onFocus: this._onFirstBumperFocus
    })), this.props.children, /*#__PURE__*/React.createElement("div", (0, _extends2.default)({}, bumperProps, {
      ref: this._lastBumper,
      onFocus: this._onLastBumperFocus
    }))), forceFocusInsideTrapOnOutsideFocus && /*#__PURE__*/React.createElement(_reactComponentEventListener.EventListener, {
      capture: true,
      listener: this._handleOutsideFocus,
      targetRef: this.windowRef,
      type: "focus"
    }), this.shouldHandleOutsideClick() && /*#__PURE__*/React.createElement(_reactComponentEventListener.EventListener, {
      capture: true,
  ...
  _proto._focusAsync = function _focusAsync(element) {
    if (!this._isBumper(element)) {
      (0, _focusUtilities.focusAsync)(element);
    }
  };
