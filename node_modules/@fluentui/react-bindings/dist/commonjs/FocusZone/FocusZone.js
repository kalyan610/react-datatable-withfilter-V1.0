...
function _onKeyDownCapture(ev) {
  if ((0, _keyboardKey.getCode)(ev) === _keyboardKey.keyboardKey.Tab) {
  ...
  function FocusZone(props) {
    ...
    _this._onKeyDown = function (ev) {
      ...
      if (shouldEnterInnerZone && shouldEnterInnerZone(ev) && _this.isImmediateDescendantOfZone(ev.target)) {
        ...
        switch ((0, _keyboardKey.getCode)(ev)) {
          case _keyboardKey.SpacebarKey:
            // @ts-ignore
          ...
          case _keyboardKey.keyboardKey.ArrowUp:
          ...
          case _keyboardKey.keyboardKey.ArrowDown:
            if (direction !== _accessibility.FocusZoneDirection.horizontal) {
              _this.preventDefaultWhenHandled(ev);
          ...
          case _keyboardKey.keyboardKey.PageDown:
          ...
          case _keyboardKey.keyboardKey.PageUp:
          ...
          case _keyboardKey.keyboardKey.Enter:
            // @ts-ignore
            if (_this.tryInvokeClickForFocusable(ev.target)) {
              break;
            }
