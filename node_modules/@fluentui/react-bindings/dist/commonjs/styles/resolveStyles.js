...
var _styles2 = require("@fluentui/styles");
...
var resolveStyles = function resolveStyles(options, resolvedVariables) {
  ...
  if (performanceFlags.enableBooleanVariablesCaching) {
    if ((0, _isPlainObject2.default)(variables)) {
    ...
    } else if (!(0, _isNil2.default)(variables)) {
      noVariableOverrides = false;
    }
  }
  ...
  if (allDisplayNames.length === 1) {
    ...
    if (_styles.length > 0) {
      mergedStyles = _styles2.mergeComponentStyles.apply(void 0, _styles);
    } else {
      mergedStyles = {
        root: function root() {
          return {};
  ...
  if (!noInlineStylesOverrides) {
    mergedStyles = (0, _styles2.mergeComponentStyles)(mergedStyles, design && (0, _styles2.withDebugId)({
      root: design
    }, 'props.design'), styles && (0, _styles2.withDebugId)({
      root: styles
    }, 'props.styles'));
  }
  ...
  Object.keys(mergedStyles).forEach(function (slotName) {
    ...
    Object.defineProperty(resolvedStyles, slotName, {
      ...
      get: function get() {
        ...
        if (process.env.NODE_ENV !== 'production' && _styles2.isDebugEnabled) {
      ...
      get: function get() {
        if (cacheEnabled && theme) {
          ...
          if (classesThemeCache[slotCacheKey] || classesThemeCache[slotCacheKey] === '') {
            ...
            return slotName === 'root' ? (0, _classnames.default)(componentClassName, classesThemeCache[slotCacheKey], className) : classesThemeCache[slotCacheKey];
          }
        } //
        // Lazy eval
        //
        ...
        if (classes[lazyEvaluationKey]) {
          return slotName === 'root' ? (0, _classnames.default)(componentClassName, classes[lazyEvaluationKey], className) : classes[lazyEvaluationKey];
        ...
        var resultClassName = slotName === 'root' ? (0, _classnames.default)(componentClassName, classes[lazyEvaluationKey], className) : classes[lazyEvaluationKey];
