...
var _shouldHandleOnKeys = require("./shouldHandleOnKeys");

var _rtlKeyMap;

var rtlKeyMap = (_rtlKeyMap = {}, _rtlKeyMap[_keyboardKey.keyboardKey.ArrowRight] = _keyboardKey.keyboardKey.ArrowLeft, _rtlKeyMap[_keyboardKey.keyboardKey.ArrowLeft] = _keyboardKey.keyboardKey.ArrowRight, _rtlKeyMap);
/**
        ...
        onKeyDown: function onKeyDown(event) {
          handledActions.forEach(function (actionName) {
            ...
            if (keyCombinations) {
              ...
              if ((0, _shouldHandleOnKeys.shouldHandleOnKeys)(event, keyCombinations)) {
