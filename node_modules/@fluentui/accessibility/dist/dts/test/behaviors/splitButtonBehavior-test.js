...
describe('SplitButtonBehavior.ts', function () {
    ...
    test('close menu with different keys', function () {
        var property = {};
        var supportedKeys = [
            { keyCode: keyboard_key_1.keyboardKey.Escape },
            { altKey: true, keyCode: keyboard_key_1.keyboardKey.ArrowUp },
    ...
    test('open menu with alt + arrow down ', function () {
        var property = {};
        var supportedKeys = [{ altKey: true, keyCode: keyboard_key_1.keyboardKey.ArrowDown }];
