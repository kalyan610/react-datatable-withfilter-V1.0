 ...
 */
exports.gridRowNestedBehavior = function (props) {
    var _a;
    return ({
        attributes: {
            root: (_a = {},
        ...
        childBehaviors: {
            cell: gridCellBehavior_1.gridCellBehavior,
        },
    });
};
