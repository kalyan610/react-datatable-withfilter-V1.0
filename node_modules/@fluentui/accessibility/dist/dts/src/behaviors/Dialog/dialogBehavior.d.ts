 ...
 */
export declare const dialogBehavior: Accessibility<DialogBehaviorProps>;
export declare type DialogBehaviorProps = {
    headerId?: string;
    contentId?: string;
} & PopupBehaviorProps & Pick<AccessibilityAttributes, 'aria-label' | 'aria-labelledby' | 'aria-describedby'>;
