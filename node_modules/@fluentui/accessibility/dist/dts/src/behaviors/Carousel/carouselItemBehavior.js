 ...
 */
exports.carouselItemBehavior = function (props) { return ({
    attributes: {
        root: {
    ...
    keyActions: {
        root: {
            arrowKeysNavigationStopPropagation: {
                keyCombinations: [{ keyCode: keyboard_key_1.keyboardKey.ArrowRight }, { keyCode: keyboard_key_1.keyboardKey.ArrowLeft }],
            },
        },
    },
}); };
