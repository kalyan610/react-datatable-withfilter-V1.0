 ...
 */
exports.menuItemBehavior = function (props) {
    var _a;
    return ({
        attributes: {
            wrapper: {
        ...
        keyActions: {
            ...
            wrapper: {
                ...
                openMenu: {
                    keyCombinations: [{ keyCode: props.vertical ? keyboard_key_1.keyboardKey.ArrowRight : keyboard_key_1.keyboardKey.ArrowDown }],
                },
            },
        },
    });
