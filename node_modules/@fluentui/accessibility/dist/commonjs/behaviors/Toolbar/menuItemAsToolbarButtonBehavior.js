...
exports.menuItemAsToolbarButtonBehavior = void 0;
 ...
 */
var menuItemAsToolbarButtonBehavior = function menuItemAsToolbarButtonBehavior(props) {
  var _root;
  ...
  return {
    attributes: {
      ...
      }, _root[_attributes.IS_FOCUSABLE_ATTRIBUTE] = !props.disabled, _root)
    },
    keyActions: {
      wrapper: {
        performClick: {
...
exports.menuItemAsToolbarButtonBehavior = menuItemAsToolbarButtonBehavior;
